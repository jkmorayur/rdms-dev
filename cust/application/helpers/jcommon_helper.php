<?php
  ...
  function send_sms($msg, $mob, $logtitle) {
       ...
       curl_setopt($ch, CURLOPT_URL, "http://sms.xpresssms.in/api/api.php?ver=1&mode=1&action=push_sms&type=1&route=2&login_name=" . $username . "&api_password=" . $password . "&message=" . $msg . "&number=" . $mobile . "&sender=" . $senderid);
  ...
  function send_otp_sms($msg, $mob, $route = 4, $tmpId = 0) {
       ...
       curl_setopt($ch, CURLOPT_POSTFIELDS, "ver=1&mode=1&action=push_sms&type=1&route=" . $route . "&login_name=" . $username . "&api_password=" . $password . "&message=" . $msg . "&number=" . $mob . "&sender=" . $senderid . "&template_id=" . $tmpId);
       $buffer = curl_exec($ch);
       curl_close($ch);

       generate_log(array(
           'log_title' => 'sent sms',
           'log_desc' => 'https://sms.xpresssms.in/api/api.php?' . "ver=1&mode=1&action=push_sms&type=1&route=" . $route . "&login_name=" . 
                         $username . "&api_password=" . $password . "&message=" . $msg . "&number=" . $mob . "&sender=" . $senderid . "&template_id=" . $tmpId,
  ...
  function encrypt($string, $type = 'E') {
     $ciphering = "AES-128-CTR";
     $options = 0;
     $encryption_iv = '1234567891011121';
     $encryption_key = "jkmorayur#@1";
     if ($type == 'E') {
