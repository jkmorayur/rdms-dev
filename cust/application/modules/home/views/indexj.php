...
<style>
     ...
     .nav-tabs>.ev.active>a, .nav-tabs>.ev.active>a:focus, .nav-tabs>.ev.active>a:hover {
     ...
     <div class="container">
          ...
          <div class="col-sm-6 pull-right mnu"> 
               <ul class="nav nav-tabs" >
                    <li><a id='evTb' class="tab" data-count='<?php print $evCount?>' data-category='ev' href="#ev" data-toggle="tab">EV</a></li>
...
<!--                     <li class="active"><a id='newTb' class="tab" data-count='<?php print $newCount?>' data-category='new' href="#latest" data-toggle="tab">Latest</a></li>-->
                    <li><a id='popTb' class="tab" data-count='<?php print $popularCount?>' data-category='popular' href="#popular" data-toggle="tab">Popular</a></li>
...
<script type="text/javascript">
     ...
     function loadMore(page, category) {
          $.ajax({
               url: site_url + 'home/loadmore?page=' + page,
               type: "GET",
     ...
     if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|SymbianOS|Windows Phone|Opera Mini/i.test(navigator.userAgent)) {
          ...
          $(window).scroll(function () {
               var hT = $('.prod_end').offset().top,
                       ...
                       wH = $(window).height(),
                       wS = $(this).scrollTop();
               if (ready && wS > (hT + hH - wH)) {
                    ready = false; //Set the flag here
                    mobPage++;
                    if (mobPage < mobTotalRecords) {
                         alert(Mobcategory);
                         loadMoreMob(mobPage, Mobcategory);
                    }
               }
     ...
     function loadMoreMob(mobPage, Mobcategory) {
          $.ajax({
               url: site_url + 'home/loadmore?page=' + mobPage,
               type: "GET",
