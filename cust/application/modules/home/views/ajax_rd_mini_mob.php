                                          ...
                                          <a href="<?php echo site_url() . 'vehicle/' . $value['prd_id'] . '-' . get_url_string($value['brd_title'] . ' ' . $value['mod_title'] . ' ' . $value['var_variant_name']);?>">
                                               <div  class="col-sm-4 wow fadeInUp" data-wow-offset="10" <?php echo $key > 0 ? ' data-wow-delay="0.2s"' : '';?>>
                                                    <div class="product_box">
                                                         <div class="image_box">
                                                              <?php echo img(array('src' => PRODUCT_BASE_URL . $img, 'alt' => $value['prd_name'], 'height'  => '238', 'width' => '380'));?>
                                                              ...
                                                              <?php //if ($value['prd_booking_status'] != 13 && $value['prd_booking_status'] != 40) {?>
                                                                <?php if ($value['prd_booking_status'] != 28 && $value['prd_booking_status'] != 40) {?>
