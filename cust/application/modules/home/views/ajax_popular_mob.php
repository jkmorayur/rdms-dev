<?php
foreach ((array) $popularVehicles['product_details'] as $key => $value) {
          ...
          <div  class="col-sm-4 wow fadeInUp" data-wow-offset="10" <?php echo $key > 0 ? ' data-wow-delay="0.2s"' : ''; ?>>
               <div class="product_box">
                    ...
                    <?php
                         ...
                         <p class=""><?php echo $value['prd_year'] ? $value['prd_year'] . '|' : ''; ?> <?php echo number_format($value['prd_km_run']); ?>kms</p>
                    </div>
               </div>
          </div>
     </a>
