                    ...
                    <div class="contact_box" style="margin-bottom: 0px;">
                         ...
                         <div class="col-sm-12 padding_0">
                              <div class="form_section">
                                   ...
                                   <form action="<?php echo site_url('highlight_residency_onam_activity/index/'); ?>" id="frmComonKerala" method="post" enctype="multipart/form-data">
                                        <?php if(!empty($auth)) { ?>
                                             <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-6">
                                             <div class="form-group">
                                                  <!-- <input autocomplete="off" type="email" name="eve_email" class="form-control" 
                                                       ...
                                                       <input autocomplete="off" type="text" name="eve_name" class="form-control" 
                                                          required autocomplete="off" placeholder="Your name">
                                             </div>
                                             <div class="form-group">
                                                  ...
                                                  <div style="width:65%;float: right;margin-bottom: 20px;">
                                                       <input name="eve_mobile" type="number" class="txtINDNumber form-control numOnlyWithoutMsg" placeholder="Mobile number"
                                        ...
                                        <div class="col-sm-6">
                                             <div class="form-group">
                                                  <input  autocomplete="off" autocomplete="off" type="text" name="eve_email"  class="form-control" placeholder="Your email">
                                             </div>
                                        </div>     
