                    ...
                    <div id="detail_slider" class="owl-carousel">
                         <?php if (!empty($productDetails['product_images'])) {?>
                                <?php foreach ($productDetails['product_images'] as $key => $value) {?>
                                     <div class="item <?php echo $key == 0 ? 'wow bounceInLeft' : '';?>" data-wow-delay="1s">
                                          <?php
                                          echo img(array('src' => './assets/uploads/product/' . $value['pdi_image'],
                                              'class' => 'img-responsive', 'data-imagezoom' => 'true', 'alt' => $value['pdi_image_alt']));
                                          ?>
                                     </div>
                                <?php }?>
                           <?php }?>
               ...
               <div class="col-sm-4 detail_cntnt wow bounceInRight" data-wow-delay="1s">
                    <h2><?php echo $productDetails['brd_title'] . ' ' . $productDetails['mod_title'] . ' ' . $productDetails['var_variant_name'];?><br>
                         <?php if ($productDetails['prd_booked'] != 1 && $productDetails['prd_soled'] != 1) {?>
                                <span>₹ <?php echo get_in_currency_format($productDetails['prd_price']);?></span></h2>
                      <?php }?>
                                          ...
                                          <div class="product_box">
                                               <div class="image_box">
                                                    ...
                                                    <?php if ($value['prd_booked'] != 1 && $value['prd_soled'] != 1) {?>
                                                         <p class="price">₹ <?php echo get_in_currency_format($value['prd_price']);?></p>
                                                    <?php }?>
