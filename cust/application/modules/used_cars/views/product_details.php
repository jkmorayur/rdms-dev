               ...
               <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                         <a href="<?php echo site_url($this->uri->segment(1)); ?>">
                              <?php echo clean_text($this->uri->segment(1)); ?>
                         </a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page"><?php echo $productDetails['brd_title'] . ' ' . $productDetails['mod_title'] . ' ' . $productDetails['var_variant_name']; ?></li>
               </ol>
          </nav>
          <div class="row" style="padding:8px;">
               <div class="col-sm-8">
                    ...
                    <?php if (!empty($productDetails['product_images'])) { ?>
                         <div style="display:none;margin:0 auto;" class="html5gallery" data-skin="gallery" data-width="480" data-height="272" data-resizemode="fill" data-thumbshowtitle="false" data-responsive="true">
                              <!-- Add images to Gallery -->
                              <?php foreach ($productDetails['product_images'] as $key => $value) { ?>
                                   <a href="<?php echo PRODUCT_BASE_URL . $value['pdi_image']; ?>">
                                        <img src="<?php echo PRODUCT_BASE_URL . $value['pdi_image']; ?>">
                                   </a>
                              <?php } ?>
                    ...
                    <?php } ?>
                    <div style="position: absolute;right: 14px;top: 0px;width: 100%;border:none;" class="product_box">
                         <div class="image_box">
                              <?php
                                echo ($productDetails['prd_booked'] == 1 && $productDetails['prd_soled'] != 1) ? '<div class="booked">Reserved</div>' : '';
                                echo ($productDetails['prd_soled'] == 1) ? '<div class="sold booked">Sold Out</div>' : '';
                              ?>
                         </div>
                    </div>
               </div>
               ...
               <div class="col-sm-4 detail_cntnt wow bounceInRight" data-wow-delay="1s">
                    <h2><?php echo $productDetails['brd_title'] . ' ' . $productDetails['mod_title'] . ' ' . $productDetails['var_variant_name']; ?><br>
                         <?php if (($productDetails['prd_booked'] != 1 && $productDetails['prd_soled'] != 1) && ($productDetails['prd_price'] > 0)) { ?>
                    ...
                    <p><?php 
                         $desc = str_replace(',', ',<br>', $productDetails['prd_desc']);
                         echo $desc; ?>
                    </p>
                    ...
                    <div class="share">
                         ...
                         <div class="a2a_kit a2a_kit_size_32 a2a_default_style" 
                              data-a2a-url="<?php echo site_url() . $this->uri->segment(1). '/' . $this->uri->segment(2); ?>" 
               ...
               <div class="col-sm-12 iconic_block padding_0">
                    <div class="col-sm-3 col-xs-6 wow fadeInUp" data-wow-offset="10">
                         <div class="text-center icon_box">
                              ...
                              <p class="value"><?php echo $productDetails['prd_year']; ?>
                         ...
                         <div class="text-center icon_box">
                              ...
                              <p class="value"><?php echo $productDetails['prd_color']; ?>
                                   <?php if(isset($productDetails['prd_wrapp_color']) && !empty($productDetails['prd_wrapp_color'])) { ?>
                                             <small style="font-size:10px;"> <?php echo $productDetails['prd_wrapp_color']; ?> </small>
                                   <?php } ?>
                              </p>
                    ...
                    <div class="col-sm-3 col-xs-6 wow fadeInUp" data-wow-offset="10" data-wow-delay="0.4s">
                         <div class="text-center icon_box">
                              ...
                              <p class="value"><?php echo number_format($productDetails['prd_km_run']); ?><small style="font-size:10px;"></small></p>
                              <p class="info">Kms</p>
                         </div>
                    </div>
                    <div class="col-sm-3 col-xs-6 wow fadeInUp" data-wow-offset="10" data-wow-delay="0.6s">
                         <div class="text-center icon_box">
                              ...
                              <p class="value"><?php echo $productDetails['prd_owner']; ?><small style="font-size:10px;"></small></p>
                    ...
                    <div class="col-sm-3 col-xs-6 wow fadeInUp" data-wow-offset="10">
                         <div class="text-center icon_box">
                              ...
                              <p class="value"><?php 
                                   $fuel = unserialize(FUAL_ADMIN);
                                   echo isset($fuel[$productDetails['prd_fual']]) ? $fuel[$productDetails['prd_fual']] : ''; ?>
                              </p>
                              <p class="info">Fuel</p>
                         </div>
                    </div>
               ...
               <div class="popular similar" >
                    ...
                    <div class="owl-carousel">
                         ...
                         foreach ($relatedVehicle as $key => $value) {
                              ...
                              <a title="<?php echo $name; ?>" href="<?php echo site_url($value['brd_slug'] . '/' . get_url_string($name) . '-' . $value['prd_id']); ?>" class="hproduct-bg">
                                   <?php
                                   $img = '';
               ...
               <div class="row">
                    <div class="modal-body">
                         <form class="refer_friend advnc_srch frmConnectWithSeller" action="<?php echo site_url('search/connectToseller'); ?>">
                              ...
                              <input type="hidden" name="cws_url" value="<?php echo site_url($productDetails['brd_slug'] . '/' . get_url_string($productDetails['brd_title'] . ' ' . $productDetails['mod_title'] . ' ' . $productDetails['var_variant_name']) . '-' . $productDetails['prd_id']); ?>"/>
                              <div class="col-sm-6">
