                    ...
                    <div class="x_content">
                         <div class="chk-container" style="float: left;width: 100%;">
                              ...
                              <span class="float-right">
                                   ...
                                   <p><h5><b><?php echo isset($purchaseTypes[$purchase_type]) ? $purchaseTypes[$purchase_type] : '';?></b></h5></p>
                                   <p>DOC NO: </p>
                                   ...
                                   <div class="row">
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                             <table class="toptable table table-stripedk table-borderedj">
                                                  <tbody>
                                                       <tr class="top-tbl-tr">
                                                            <td><b>Vehicle Registration NO :</b> <?php echo $result['masterData']['val_prt_1'] . '-' . $result['masterData']['val_prt_2'] . '-' . $result['masterData']['val_prt_3'] . '-' . $result['masterData']['val_prt_4'];?> </td>
