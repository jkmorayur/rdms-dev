...
//                '919633334477', // Bava Sir
    ...
    renewal on ' . date('d-m-Y', strtotime($value['val_insurance_comp_date']));
                      ...
                      $postArray = array(
                          'ApiKey' => 'AzsdSFt21JOEHYuUcpD0LRqd88dYPY1wlkT0EgXiYJc=',
                          'ClientId' => '47d5c8bf-817d-4c5b-9c57-542ebbd41434',
                          'SenderId' => $senderid,
                          'Message' => $msg,
                          'MobileNumbers' => $to,
                          'principleEntityId' => '1601100000000014534',
                          'templateId' => $tmpId
                      );

                      $payload = json_encode($postArray);
                      $ch = curl_init("http://api.xpresssms.in/api/v2/SendSMS");
