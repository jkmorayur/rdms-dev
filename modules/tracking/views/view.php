                         ...
                         <div class="x_content">
                              ...
                              <div class="form-horizontal form-label-left">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <select class="select2_group form-control" name="trk_vehicle_no">
                                                  ...
                                                  <?php foreach ((array) $vehicles as $key => $value) {?>
                                                         <option <?php echo $value['val_id'] == $trackingVehicles['trk_vehicle_no'] ? 'selected="selected"' : '';?>
                                                              value="<?php echo $value['val_id'];?>"><?php echo $value['val_veh_no'];?></option>
                                                         <?php }?>
                                             </select>
                                        </div>
                                   </div>
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <select class="select2_group form-control" name="trk_out_pass_rd_driver" required="required"
                                                  ...
                                                  <optgroup label="Royal drive staf">
                                                       <?php foreach ($stafs as $key => $value) {?>
                                                              <option <?php echo $trackingVehicles['trk_out_pass_rd_driver'] == $value['usr_id'] ? 'selected="selected"' : '';?>
                                   ...
                                   <div class="form-group divDriverOut" style="<?php echo empty($trackingVehicles['trk_out_pass_other_driver']) ? 'display: none;' : '';?>">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input value="<?php echo $trackingVehicles['trk_out_pass_other_driver'];?>" id="trk_out_pass_other_driver" class="form-control col-md-7 col-xs-12" 
                                                    name="trk_out_pass_other_driver">
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <select class="select2_group form-control" name="trk_out_pass_to" required="required"
                                                     onchange="if ($(this).val() < 0) {
                                                  ...
                                                  <optgroup label="Royal drive showrooms">
                                                       <?php foreach ($showrooms as $key => $value) {?>
                                                              <option 
                                                              <?php echo $trackingVehicles['trk_out_pass_to'] == $value['shr_id'] ? 'selected="selected"' : '';?>
                                   ...
                                   <div class="form-group divOutPassToPlace" style="<?php echo empty($trackingVehicles['trk_out_pass_to_place']) ? 'display: none;' : '';?>">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input value="<?php echo $trackingVehicles['trk_out_pass_to_place'];?>" id="trk_out_pass_to_place" 
                                                    class="form-control col-md-7 col-xs-12" type="text" name="trk_out_pass_to_place">
                                        </div>
                                   </div>
                                   <!-- -->
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input value="<?php echo $trackingVehicles['trk_out_pass_km'];?>" id="trk_out_pass_km" 
                                                    class="form-control col-md-7 col-xs-12 numOnly" type="text" name="trk_out_pass_km" >
                                        </div>
                                   </div>
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input value="<?php echo $trackingVehicles['trk_out_pass_est_return_time'];?>" id="trk_out_pass_est_return_time" class="dtpDateTimePicker form-control col-md-7 col-xs-12 numOnly" 
                                                    type="text" name="trk_out_pass_est_return_time" placeholder="text" >
                                        </div>
                                   </div>
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <select class="select2_group form-control" name="trk_check_in_rd_driver"
                                                     onchange="if ($(this).val() < 0) {
                                                                    $('.divDriverIn').show();
                                                  ...
                                                  <optgroup label="Royal drive staf">
                                                       <?php foreach ($stafs as $key => $value) {?>
                                                              <option <?php echo ($value['usr_id'] == $trackingVehicles['trk_check_in_rd_driver']) ? 'selected="selected"' : '';?>
                                                                   value="<?php echo $value['usr_id'];?>"><?php echo $value['usr_first_name'] . ' - ' . $value['shr_location'];?></option>
                                                              <?php }?>
                                                  </optgroup>
                                             </select>
                                   ...
                                   <div class="form-group divDriverIn" style="<?php echo empty($trackingVehicles['trk_check_in_other_driver']) ? 'display: none;' : ''?>">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input value="<?php echo $trackingVehicles['trk_check_in_other_driver'];?>" id="trk_check_in_other_driver" 
                                                    class="form-control col-md-7 col-xs-12" name="trk_check_in_other_driver"/>
                                        </div>
                                   </div>
                                   <!-- -->
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <select class="select2_group form-control" name="trk_check_in_rd_showroom"
                                                     onchange="if ($(this).val() < 0) {
                                                  ...
                                                  <optgroup label="Royal drive showrooms">
                                                       <?php foreach ($showrooms as $key => $value) {?>
                                                              <option <?php echo ($value['shr_id'] == $trackingVehicles['trk_check_in_rd_showroom']) ? 'selected="selected"' : '';?>
                                                                   value="<?php echo $value['shr_id'];?>"><?php echo $value['shr_location'];?></option>
                                                              <?php }?>
                                                  </optgroup>
                                             </select>
                                   ...
                                   <div class="form-group divCheckInPlace" style="<?php echo empty($trackingVehicles['trk_check_in_other_place']) ? 'display: none;' : ''?>">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input value="<?php echo $trackingVehicles['trk_check_in_other_place'];?>" id="trk_check_in_other_place" 
                                                    class="form-control col-md-7 col-xs-12" type="text" name="trk_check_in_other_place">
                                        </div>
                                   </div>
                                   <!-- -->
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input value="<?php echo $trackingVehicles['trk_check_in_date'];?>" id="trk_check_in_date" 
                                                    class="dtpDateTimePicker form-control col-md-7 col-xs-12 dtpDateTimePicker" 
                                                    type="text" name="trk_check_in_date" <?php echo!empty($trackingVehicles['trk_check_in_date']) ? 'required="required"' : '';?> placeholder="DD-MM-YYYY H:M AM/PM" >
                                        </div>
                                   </div>
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input value="<?php echo $trackingVehicles['trk_check_in_km'];?>" id="trk_check_in_km" class="form-control col-md-7 col-xs-12 numOnly" type="number" 
                                                    name="trk_check_in_km" <?php echo!empty($trackingVehicles['trk_check_in_km']) ? 'required="required"' : '';?>>
                                        </div>
                                   </div>
