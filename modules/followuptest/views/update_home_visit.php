...
<div class='flds'>
     <div class="panel pnl-bg-color panel-default enq-sts-bg">
          ...
          <div class="panel-body">
                <input type="text" name="hmv_enq_id" value="<?php echo $homeVisit['hmv_enq_id'] ?>">
               <div class="row">
               ...
               <div class="row">
                ...
                <div class="row">
                    <?php if ($homeVisit['hmv_executive_remark']) {?>
                           <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                <label class="lbl">Executive Remak</label> :<span class="txt"><?php echo $homeVisit['hmv_executive_remark']?></span>
                           </div>
                      <?php }?>
