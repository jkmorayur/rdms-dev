...
<div class="modal fade" id="homeVisit" role="dialog" >
     ...
     <div class="modal-dialog ">
<?php echo form_open_multipart($controller."/storeHomeVisit", array('id' => "home_Visit", 'class' => "submitHomeVisit  modal-content form-horizontal form-label-left"))?>
