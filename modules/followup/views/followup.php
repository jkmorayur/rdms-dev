                         ...
                         <ul class="nav navbar-right panel_toolbox">
                              <li class="dropdown" style="float: right;">
                                   ...
                                   <ul class="dropdown-menu" role="menu">
                                        ...
                                        ?> <li><a target="blank" href="<?php echo site_url('enquiry/view_change/' . encryptor($vehicles['enq_id'])); ?>">Edit enquiry</a></li> <?php
                                                                                                                                                                          }
                                                                                                                                                                     } else { ?>
                                             <li><a target="blank" href="<?php echo site_url('enquiry/view_change/' . encryptor($vehicles['enq_id'])); ?>">Edit enquiry.</a></li>
                                        <?php }
                                        ...
                                        <?php }
                                                                                                                                                                     if (check_permission('homevisit', 'hw_can_add_request')) { ?>
                                             <li><a data-toggle="modal" data-target="#homeVisit" href="javascript:void(0);">Home Visit</a></li>
                                        <?php }
                                                                                                                                                                     if (check_permission($controller, 'submittestdrive')) { ?>
                                             <li><a data-toggle="modal" data-target="#testDrive" href="javascript:void(0);">Test Drive</a></li>
                                        <?php } ?>
                                   </ul>
                              </li>
                         </ul>
                                                       ...
                                                       <li fd="<?php echo isset($value['foll_id']) ? $value['foll_id'] : 0; ?>">
                                                            <div class="block">
                                                                 ...
                                                                 ?><style>
                                                                           ...
                                                                           .tagcolor<?php echo $value['foll_id']; ?>::after {
                                                                 ...
                                                                 <div style="margin-top: 10px;width:100%;padding-top:20px;font-style: italic;background: #E7E7E7;padding: 10px;border-radius: 10px;float: left;">
                                                                      Comments : <p class="excerpt"><?php echo isset($value['foll_remarks']) ? $value['foll_remarks'] : ''; ?></p>
                                                                 </div>
                                                                 <!-- -->
                                                                 <?php if ($value['folloup_added_by_id'] != $this->uid) { ?>
                                                                      <p style="width:100%;" class="excerpt alignright">Added by : <?php
                                                                                                                                       echo isset($value['folloup_added_by']) ?
                                                                                                                                            $value['folloup_added_by'] . ' (' . $value['shr_location'] . ')' : '';
                                                                                                                                       ?>
                                                                           <?php echo date('d-m-Y h:i:s', strtotime($value['foll_entry_date'])); ?>
                                                                 ...
                                                                 <?php } else { ?>
                                                                      <p style="width:100%;" class="excerpt alignright">Added by :- Self <?php echo date('d-m-Y h:i:s', strtotime($value['foll_entry_date'])); ?></p>
                                                                 <?php } ?>
                    ...
                    <div class='flds'>
                         ...
                         <div class="row">
                              <div class="form-group col-md-3 col-sm-3 col-xs-6">
                                   ...
                                   <input type="text" class="form-control col-md-7 col-xs-12 dtpDatePickerDMY" name="hmv_date" id="date" placeholder="Date" autocomplete="off">
                              </div>
                              <div class="form-group col-md-3 col-sm-3 col-xs-6">
                              ...
                              <div class="form-group col-md-6 col-sm-6 col-xs-6">
                                   ...
                                   <input type="text" class="form-control col-md-7 col-xs-12" id="pac-input" name="hmv_place" placeholder="Enter Place" autocomplete="off">
