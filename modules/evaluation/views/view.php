                              ...
                              <div>
                                   <div id="step-1" class="step-1">
                                        ...
                                        <div class="row">
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <select required class="select2_group form-control cmbBindShowroomByDivision" name="valuation[val_division]" id="vreg_division"
                                             ...
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <select required id="cmbRegisterAssignTo" class="cmbRegisterAssignTo select2_group form-control enq_se_id" 
                                                  ...
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            ...
                                                            <input  type="text" class="form-control col-md-7 col-xs-12 dtpDatePickerDMY" 
                                                                   value="<?php echo $evDate;?>"  name="valuation[val_valuation_date]" id="val_valuation_date" placeholder="Date" required="required"/>
                                                       </div>
                                                  </div>
                                             </div>
                                        </div>
                                                  ...
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            ...
                                                            <select required <?php //echo ($readOnly == 1) ? 'disabled' : '';?> 
                                                                 ...
                                                                 <option value="623" <?php echo ($vehicles['val_evaluator'] == 623) ? 'selected="selected"' : '';?>>Sidharth</option>
                                                                 <?php
                                                                   if (!empty($evaluators)) {
                                        ...
                                        <div class="row">
                                             ...
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input required type="text" class="form-control col-md-4 col-xs-6 hourPicker"
                                                            ...
                                                            <select class="select2_group form-control" name="valuation[val_mis]" id="val_mis">
                                                                 ...
                                                                 if (!empty($mis)) {
                                                                      foreach ($mis as $key => $value) {
                                                                           ?>
                                                                           <option <?php echo ($vehicles['val_mis'] == $value['usr_id']) ? 'selected="selected"' : ''; ?> 
                                                                                value="<?php echo $value['usr_id']; ?>"><?php echo $value['usr_first_name'] . ' (' . $value['shr_location'] . ')'; ?></option>
                                                                                <?php
                                                                           }
                                                                      }
                                                                      ?>
                                                            ...
                                                            <select required class="select2_group form-control" name="valuation[val_delco]" id="val_manager">
                                                                 ...
                                                                 if (!empty($delco)) {
                                                                      foreach ($delco as $key => $value) {
                                                                           ?>
                                                                           <option <?php echo ($vehicles['val_delco'] == $value['usr_id']) ? 'selected="selected"' : ''; ?> 
                                                                                value="<?php echo $value['usr_id']; ?>"><?php echo $value['usr_first_name'] . ' (' . $value['shr_location'] . ')'; ?></option>
                                                                                <?php
                                                                           }
                                                                      }
                                                            ...
                                                            <option value="">Select Sales Admin Staff</option>
                                                                 ...
                                                                 if (!empty($admin)) {
                                                                      foreach ($admin as $key => $value) {
                                                                           ?>
                                                                           <option <?php echo ($vehicles['val_admin'] == $value['usr_id']) ? 'selected="selected"' : ''; ?>  
                                                                                value="<?php echo $value['usr_id']; ?>"><?php echo $value['usr_first_name'] . ' (' . $value['shr_location'] . ')'; ?></option>
                                                                                <?php
                                                                           }
                                                                      }
                                                            ...
                                                            <select class="select2_group form-control" name="valuation[val_purchase_admin]" id="val_purchase_admin">
                                                                 ...
                                                                 if (!empty($purchaseAdmin)) {
                                                                      foreach ($purchaseAdmin as $key => $value) {
                                                                           ?>
                                                                           <option <?php echo ($vehicles['val_purchase_admin'] == $value['usr_id']) ? 'selected="selected"' : ''; ?>   
                                                                                value="<?php echo $value['usr_id']; ?>"><?php echo $value['usr_first_name'] . ' (' . $value['shr_location'] . ')'; ?></option>
                                                                                <?php
                                                                           }
                                                                      }
                                                            ...
                                                            <select class="select2_group form-control" name="valuation[val_apm_asm]" id="val_apm_asm">
                                                                 ...
                                                                 if (!empty($APMASM)) {
                                                                      foreach ($APMASM as $key => $value) {
                                                                           ?>
                                                                           <option <?php echo ($vehicles['val_apm_asm'] == $value['col_id']) ? 'selected="selected"' : ''; ?> 
                                                                                value="<?php echo $value['col_id']; ?>"><?php echo $value['col_title'] . ' (' . $value['shr_location'] . ')'; ?></option>
                                                                                <?php
                                                                           }
                                                                      }
                                                            ...
                                                            <select class="select2_group form-control" name="valuation[val_tele_caller]" id="val_tele_caller">
                                                                 ...
                                                                 if (!empty($teleclrs)) {
                                                                      foreach ($teleclrs as $key => $value) {
                                                                           ?>
                                                                           <option <?php echo ($vehicles['val_tele_caller'] == $value['usr_id']) ? 'selected="selected"' : ''; ?>  
                                                                                value="<?php echo $value['usr_id']; ?>"><?php echo $value['usr_first_name'] . ' (' . $value['shr_location'] . ')'; ?></option>
                                                                                <?php
                                                                           }
                                                                      }
                                                            ...
                                                            <select class="select2_group form-control" name="valuation[val_tsc]" id="val_tsc">
                                                                 ...
                                                                 if (!empty($telprsco)) {
                                                                      foreach ($telprsco as $key => $value) {
                                                                           ?>
                                                                           <option <?php echo ($vehicles['val_tsc'] == $value['usr_id']) ? 'selected="selected"' : ''; ?>   
                                                                                value="<?php echo $value['usr_id']; ?>"><?php echo $value['usr_first_name'] . ' (' . $value['shr_location'] . ')'; ?></option>
                                                                                <?php
                                                                           }
                                                                      }
                                        ...
                                        <div class="row">
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" id="val_prt_1" class="txtRegNo1 form-control col-md-7 col-xs-12" name="valuation[val_prt_1]" 
                                                                   value="<?php echo $vehicles['val_prt_1'];?>"  maxlength="2" style="text-transform: uppercase;width: 49px;" 
                                                                   required placeholder="KL" onkeyup="$(this).val().length === 2 ? $('.txtRegNo2').focus() : '';"/>

                                                            <input type="text" class="txtRegNo2 form-control col-md-7 col-xs-12" name="valuation[val_prt_2]" 
                                                                   value="<?php echo $vehicles['val_prt_2'];?>" maxlength="2" style="text-transform: uppercase;width: 49px;" 
                                                                   required placeholder="00" onkeyup="$(this).val().length === 2 ? $('.txtRegNo3').focus() : '';"/>

                                                            <input type="text" class="txtRegNo3 form-control col-md-7 col-xs-12" name="valuation[val_prt_3]" 
                                                                   value="<?php echo $vehicles['val_prt_3'];?>" maxlength="2" style="text-transform: uppercase;width: 49px;" 
                                                                   placeholder="AA" onkeyup="$(this).val().length === 2 ? $('.txtRegNo4').focus() : '';"/>

                                                            <input type="text" class="txtRegNo4 form-control col-md-7 col-xs-12" name="valuation[val_prt_4]" 
                                        ...
                                        <div class="row">
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input required="required" class="form-control col-md-7 col-xs-12 dtpDatePickerEvaluation" placeholder="Delivery Date"
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <select required class="select2 select2_group form-control" name="valuation[val_color]" id="val_color">
                                                                 <?php foreach ($color as $key => $value) {?>
                                                                        <option <?php echo ($vehicles['val_color'] == $value['vc_id']) ? 'selected="selected"' : ''; ?> 
                                        ...
                                        <div class="row">
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="number" class="form-control col-md-4 col-xs-4 numOnly val_model_year" onkeyup="$(this).val().length === 4 ? $('.txtMnfYear').focus() : '';"
                                                            ...
                                                            <input type="number" class="txtMnfYear form-control col-md-4 col-xs-6 numOnly val_minif_year"
                                                  ...
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="number" class="form-control col-md-7 col-xs-12 numOnly" name="valuation[val_km]" 
                                                                   value="<?php echo $vehicles['val_km'];?>" id="val_km" placeholder="Mileage" required/>
                                                       </div>
                                                  </div>
                                             </div>
                                        ...
                                        <div class="row">
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       <label class="control-label col-md-4 col-sm-3 col-xs-12">A/C & A/C Zone</label>
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                  ...
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input required="required" class="form-control col-md-7 col-xs-12 numOnly" 
                                                                   ...
                                                                   type="number" name="valuation[val_no_of_owner]" id="val_no_of_owner">
                                                       </div>
                                                  </div>
                                             </div>
                                             <!--                                             <div class="col-sm-6">
                                                  ...
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" class="form-control col-md-7 col-xs-12" name="valuation[val_eng_cc]" 
                                                                  required value="<?php echo $vehicles['val_eng_cc'];?>" id="val_eng_cc" placeholder="Cubic Capacity"/>
                                                       </div>
                                                  </div>
                                             </div>
                                             <!-- <div class="col-sm-6">
                                        ...
                                        <div class="row">
                                             ...
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input required="required" class="form-control col-md-7 col-xs-12 numOnly" 
                                                                   value="<?php echo $vehicles['val_no_of_seats'];?>" placeholder="No.of Seats" type="number" name="valuation[val_no_of_seats]" id="val_no_of_seats">
                                                       </div>
                                                  </div>
                                             </div>
                                        </div>
...
<!--                                        <div class="row">
                                        ...
                                        <div class="row">
                                             ...
                                             <table class="table table-striped table-bordered">
                                                  ...
                                                  <tr>
                                                       <td>Comprehensive</td>
                                                       <td><input value="<?php echo!empty($vehicles['val_insurance_comp_date']) ? date('d-m-Y', strtotime($vehicles['val_insurance_comp_date'])) : '';?>" 
                                                                  placeholder="Valid UP to (comprehensive)" type="text" class="dtpDatePickerEvaluation form-control col-md-7 col-xs-12" name="valuation[val_insurance_comp_date]"/></td>
                                                  ...
                                                  <tr>
                                                       ...
                                                       <td><input value="<?php echo!empty($vehicles['val_insurance_ll_date']) ? date('d-m-Y', strtotime($vehicles['val_insurance_ll_date'])) : '';?>" 
                                                                  placeholder="Limited Liability (Limited Liability)" type="text" class="dtpDatePickerEvaluation form-control col-md-7 col-xs-12" name="valuation[val_insurance_ll_date]"/></td>
                                        ...
                                        <div class="row">
                                             ...
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="number" class="form-control col-md-7 col-xs-12 decimalOnly" value="<?php echo $vehicles['val_hypo_loan_amt'];?>"
                                        ...
                                        <div class="row">
                                             <div class="col-sm-4">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="number" class="form-control col-md-7 col-xs-12 numOnly" name="valuation[val_air_bags]" 
                                             ...
                                             <div class="col-sm-4">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="number" class="form-control col-md-7 col-xs-12 numOnly" name="valuation[val_exhaust]" 
                                             ...
                                             <div class="col-sm-4">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="number" class="form-control col-md-7 col-xs-12 numOnly" name="valuation[val_no_of_pw]" 
                                             ...
                                             <table class="table table-striped table-bordered">
                                                  ...
                                                  <tbody>
                                                       ...
                                                       <tr class="tdValidityKM" style="<?php echo ($vehicles['val_wrnty'] == 0) ? 'display: none;' : '';?>">
                                                            ...
                                                            <td colspan="2">
                                                                 <input value="<?php echo $vehicles['val_wrnty_km'];?>" 
                                                                        type="number" class="form-control numOnly" style="width: 100%;" id="val_wrnty_km" name="valuation[val_wrnty_km]"/>
                                                            </td>
                                                       </tr>
                                                       <tr>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td><input type="number" class="form-control numOnly txtNextServiceDays" value="<?php echo $vehicles['val_next_serv_days'];?>"
