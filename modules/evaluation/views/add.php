                                             ...
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            ...
                                                            <select required="true" class="select2_group form-control" name="valuation[val_evaluator]" id="val_evaluator">
                                                                 ...
                                                                 <?php
                                                                   if (!empty($evaluators)) {
                                                                      ...
                                                                      ?>
                                                                      <option <?php echo ($this->uid == 720) ? 'selected="selected"' : '';?> value="720">Robin cheriyan</option>
                                                            </select>
                                                       </div>
                                                  </div>
                                             </div>
                                        ...
                                        <div class="row">
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" class="txtRegNo1 form-control col-md-7 col-xs-12" name="valuation[val_prt_1]" 
                                                            ...
                                                            <input type="text" class="txtRegNo3 form-control col-md-7 col-xs-12" name="valuation[val_prt_3]" 
                                                                   maxlength="2" style="text-transform: uppercase;width: 49px;" placeholder="AA"
                                        ...
                                        <div class="row">
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="number" class="form-control col-md-4 col-xs-6 numOnly val_model_year" onkeyup="$(this).val().length === 4 ? $('.txtMnfYear').focus() : '';"
                                                  ...
                                                  <table class="table table-striped table-bordered">
                                                       ...
                                                       <tbody class="tbUpgradDet">
                                                            <tr>
                                                                 ...
                                                                 <td><input name="upgradedetails[upgrd_value][]" placeholder="Refurbish amount" class="form-control txtUpgradDetValue" type="number" style="width: 100%;"/></td>
                                             ...
                                             <table class="table table-striped table-bordered">
                                                  ...
                                                  <tbody>
                                                       <tr>
                                                            ...
                                                            <td>
                                                                 <input class="form-control" type="text" id="val_pfr" name="valuation[val_pfr]">
                                                            </td>

                                                            <td class="td-head"> Glass - Wint sheeld</td>
                                                            <td>
                                                                 <input class="form-control" type="text" id="val_gws" name="valuation[val_gws]">
                                                            </td>
                                                       </tr>
                                                       <tr>
                                                            <td class="td-head"> FL</td>
                                                            <td>
                                                                 <input class="form-control" type="text" id="val_pfl" name="valuation[val_pfl]">
                                                            </td>

                                                            <td class="td-head"> Rear Glass</td>
                                                            <td>
                                                                 <input class="form-control" type="text" id="val_grg" name="valuation[val_grg]">
                                                            </td>
                                                       </tr>
                                                       <tr>
                                                            <td class="td-head"> CR</td>
                                                            <td>
                                                                 <input class="form-control" type="text" id="val_pcr" name="valuation[val_pcr]">
                                                            </td>

                                                            <td class="td-head"> Door Glass R</td>
                                                            <td>
                                                                 <input class="form-control" type="text" id="val_gdgr" name="valuation[val_gdgr]">
                                                            </td>
                                                       </tr>
                                                       <tr>
                                                            <td class="td-head"> CL</td>
                                                            <td>
                                                                 <input class="form-control" type="text" id="val_pcl" name="valuation[val_pcl]">
                                                            </td>

                                                            <td class="td-head"> Door Glass LS</td>
                                                            <td>
                                                                 <input class="form-control" type="text" id="val_gdgls" name="valuation[val_gdgls]">
                                                            </td>
                                                       </tr>
                                                       <tr>
                                                            <td class="td-head"> RR</td>
                                                            <td>
                                                                 <input class="form-control" type="text" id="val_prr" name="valuation[val_prr]">
                                                            </td>

                                                            <td class="td-head"> Q Glass R</td>
                                                            <td>
                                                                 <input class="form-control" type="text" id="val_qgr" name="valuation[val_qgr]">
                                                            </td>
                                                       </tr>
                                                       <tr>
                                                            <td class="td-head"> RL</td>
                                                            <td>
                                                                 <input class="form-control" type="text" id="val_prl" name="valuation[val_prl]">
                                                            </td>

                                                            <td class="td-head"> Q Glass I</td>
                                                            <td>
                                                                 <input class="form-control" type="text" id="val_qgi" name="valuation[val_qgi]">
                                                            </td>
                                                       </tr>
                                                  </tbody>
                                             </table>
                                             ...
                                             <table class="table table-striped table-bordered">
                                                  ...
                                                  <tbody>
                                                       <tr>
                                                            ...
                                                            <td>
                                                                 <input class="form-control" type="text" id="val_tyre_2_wek" name="valuation[val_tyre_2_wek]" placeholder="Week"/>
                                                            </td>
                                                            <td>
                                                                 <input class="form-control" type="text" id="val_tyre_2_yer" name="valuation[val_tyre_2_yer]" placeholder="Year">
                                                            </td>
                                                            <td>
                                                                 <input class="form-control" type="text" id="val_tyre_2_per" name="valuation[val_tyre_2]" placeholder="Percentage">
                                                            </td>

                                                            <td class="td-head"> Tire - FL</td>
                                                            <td>
                                                                 <input class="form-control" type="text" id="val_tyre_1_wek" name="valuation[val_tyre_1_wek]" placeholder="Week">
                                                            </td>
                                                            <td>
                                                                 <input class="form-control" type="text" id="val_tyre_1_yer" name="valuation[val_tyre_1_yer]" placeholder="Year">
                                                            </td>
                                                            <td>
                                                                 <input class="form-control" type="text" id="val_tyre_1_per" name="valuation[val_tyre_1]" placeholder="Percentage">
                                                            </td>
                                                       </tr>
                                                       <tr>
                                                            <td class="td-head"> Tire - RR</td>
                                                            <td>
                                                                 <input class="form-control" type="text" id="val_tyre_4_wek" name="valuation[val_tyre_4_wek]" placeholder="Week">
                                                            </td>
                                                            <td>
                                                                 <input class="form-control" type="text" id="val_tyre_4_yer" name="valuation[val_tyre_4_yer]" placeholder="Year">
                                                            </td>
                                                            <td>
                                                                 <input class="form-control" type="text" id="val_tyre_4_per" name="valuation[val_tyre_4]" placeholder="Percentage">
                                                            </td>

                                                            <td style="width: 90px;" class="td-head"> Tire - RL</td>
                                                            <td>
                                                                 <input class="form-control" type="text" id="val_tyre_3_wek" name="valuation[val_tyre_3_wek]" placeholder="Week">
                                                            </td>
                                                            <td>
                                                                 <input class="form-control" type="text" id="val_tyre_3_yer" name="valuation[val_tyre_3_yer]" placeholder="Year">
                                                            </td>
                                                            <td>
                                                                 <input class="form-control" type="text" id="val_tyre_3_per" name="valuation[val_tyre_3]" placeholder="Percentage">
                                                            </td>
                                                       </tr>
                                                       <tr>
                                                            <td style="width: 90px;" class="td-head"> Spare tire</td>
                                                            <td>
                                                                 <input class="form-control" type="text" id="val_tyre_5_wek" name="valuation[val_tyre_5_wek]" placeholder="Week">
                                                            </td>
                                                            <td>
                                                                 <input class="form-control" type="text" id="val_tyre_5_yer" name="valuation[val_tyre_5_yer]" placeholder="Year">
                                                            </td>
                                                            <td>
                                                                 <input class="form-control" type="text" id="val_tyre_5_per" name="valuation[val_tyre_5]" placeholder="Percentage">
                                                            </td>
