                         ...
                         <form id="demo-form2" method="post" action="<?php echo site_url($controller . '/update');?>" data-parsley-validate class="form-horizontal form-label-left frmEmployee" enctype="multipart/form-data">
                              ...
                              <div class="form-row">
                                   <div class="form-group col-md-4">
                                        ...
                                        <input value="<?php echo $userDetails['usr_first_name']?>" type="text" id="first-name" 
                                               required="required" class="form-control" name="usr_first_name">
                                   </div>
                                   <div class="form-group col-md-4">
                                   ...
                                   <div class="form-group col-md-4">
                                        ...
                                        <select class="cmbShowRoom select2_group form-control" name="usr_showroom"
                                                data-url="<?php echo site_url('emp_details/getTeamLeads');?>">
                                                    ...
                                                    <option <?php echo ($value['shr_id'] == $userDetails['usr_showroom']) ? 'selected="selected"' : '';?> 
                              ...
                              <div class="form-row">
                                   <div class="form-group col-md-4">
                                        ...
                                        <select class="form-control bindToDropdown" name="usr_group" 
                                                data-bind="cmbGrade" data-dflt-select="Select Grade"
                                                data-url="<?php echo site_url($controller . '/bindDesignationGrades');?>"
                                                onchange="/*this.value == 8 ? $('.divTeamLead').show() : $('.divTeamLead').hide();*/">
                                             <option value="">Select designation</option>
                                             <?php foreach ($designationOld as $key => $value) {?>
                                                    <option <?php echo ($value['id'] == $currDesignation) ? 'selected="selected"' : '';?>  
                                   ...
                                   <div class="form-group col-md-4">
                                        ...
                                        <select class="form-control cmbGrade" name="usr_grade">
                                             ...
                                             <?php foreach ((array) $grades as $key => $value) {?>
                                                    <option <?php echo ($value['col_id'] == $userDetails['usr_grade']) ? 'selected="selected"' : '';?>  
                                   ...
                                   <div class="form-group col-md-4">
                                        ...
                                        <select class="cmbShowRoom select2_group form-control" name="usr_departments">
                                             ...
                                             <?php foreach ($departments as $key => $value) {?>
                                                    <option <?php echo ($value['dep_id'] == $userDetails['usr_departments']) ? 'selected="selected"' : '';?> 
                              ...
                              <div class="form-row">
                                   <div class="form-group col-md-4 divTeamLead" style="<?php /*echo empty($userDetails['usr_tl']) ? 'display: none;' : ''*/?>">
                                        ...
                                        <select class="cmbTeamLead1 cmbselect2_group form-control" name="usr_tl">
                                             ...
                                             <?php foreach ($teamLeads as $key => $value) {?>
                                                    <option <?php echo ($value['col_id'] == $userDetails['usr_tl']) ? 'selected="selected"' : '';?> 
                                                         value="<?php echo $value['col_id'];?>"><?php echo $value['col_title'];?></option>
                                                         <?php
                                                    }
                                                  ?>
                                   ...
                                   <div class="form-group col-md-4">
                                        ...
                                        <input type="text" id="last-name" name="usr_phone" data-past=".usr_whatsapp" 
                                               value="<?php echo $userDetails['usr_phone']?>" class="form-control">
                                   </div>
                                   <div class="form-group col-md-4">
                                        <label for="inputEmail4">Whatsapp <span class="required">*</span></label>
                                        <input type="text" id="last-name" name="usr_whatsapp" 
                                               value="<?php echo $userDetails['usr_whatsapp']?>" class="numOnly form-control usr_whatsapp">
                                   </div>
                              </div>
                              <div class="form-row">
                                   <div class="form-group col-md-4">
                                   ...
                                   <div class="form-group col-md-4">
                                        ...
                                        <input type="text" id="usr_password_conf" name="usr_password_conf"  
                                               class="form-control usr_password_conf">
                                   </div>
                              </div>
                              <div class="form-row">
                                   <div class="form-group col-md-4">
                                   ...
                                   <div class="form-group col-md-4">
                                        ...
                                        <select required class="cmbSearchList form-control bindToDropdown" name="usr_designation_new">
                                             ...
                                             <?php foreach ($designation as $key => $value) { ?>
                                                  <option <?php echo ($value['desig_id'] == $userDetails['usr_designation_new']) ? 'selected="selected"' : ''; ?> 
                                                       value="<?php echo $value['desig_id']; ?>"><?php echo $value['desig_title']; ?></option>
                                             <?php } ?>
                                        </select>
                                   </div>
                                   <div class="form-group col-md-4">
                                   ...
                                   <div class="form-group col-md-4">
                                        ...
                                        <select required class="form-control bindToDropdown" name="usr_rol">
                                             ...
                                             <?php foreach ($roles as $key => $value) { ?>
                                                  <option <?php echo ($value['rol_id'] == $userDetails['usr_rol']) ? 'selected="selected"' : ''; ?> value="<?php echo $value['rol_id']; ?>"><?php echo $value['rol_name']; ?></option>
                                             <?php } ?>
                                        </select>
                                   </div>
                                   <div class="form-group col-md-4">
                                        <label for="inputEmail4"> </label>
                                        <button type="submit" class="btn btn-primary form-control">Update Employee Details</button>
                                   </div>
                              </div>
                         </form>
                    </div>
