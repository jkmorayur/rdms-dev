...
<?php } ?>
                                   ...
                                   <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                             ...
                                             <div class="col-md-6 col-sm-6 col-xs-12">
                                                  <select <?php echo isset($mandatory['vreg_department']) ? 'required' : '';?> class="select2_group form-control cmbDepartment" 
                                                            name="vreg_department" id="vreg_department">
     ...
     <!-- @ -->
                                        ...
                                        <div class="form-group">
                                             <label class="control-label col-md-3 col-sm-3 col-xs-12">Email
                                                  <?php echo isset($mandatory['vreg_email']) ? '<span class="required">*</span>' : '';?>
                                             </label>
                                             <div class="col-md-6 col-sm-6 col-xs-12">
                                                  <input <?php echo isset($mandatory['vreg_email']) ? 'required' : '';?> type="text" class="form-control col-md-7 col-xs-12 vreg_email" name="vreg_email" id="vreg_email" placeholder="Email" 
                                        ...
                                        <div class="form-group">
                                             ...
                                             <div class="col-md-6 col-sm-6 col-xs-12">
                                                  <input <?php echo isset($mandatory['vreg_cust_place']) ? 'required' : '';?> type="text" class="form-control col-md-7 col-xs-12" name="vreg_cust_place" id="vreg_cust_place"
...
<div class="tmpSaleRelated" style="display: none;">
     ...
     <div class="form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
               <select <?php echo ($this->desi != 'AH' || $this->desi != 'CRE') ? 'required' : '';?> data-url="<?php echo site_url('enquiry/bindModel');?>" data-bind="cmbEvModel" 
     ...
     <div class="form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
               <select <?php echo ($this->desi != 'AH') ? 'required' : '';?> data-url="<?php echo site_url('enquiry/bindVarient');?>" data-bind="cmbEvVariant" data-dflt-select="Select Variant"
...
<!--               <input type="text" class="numOnly form-control col-md-7 col-xs-12" name="vreg_year" id="vreg_year"
                      autocomplete="off" placeholder="Year"/>-->
                                                  ...
                                                  <select <?php echo ($this->desi != 'AH') ? 'required' : '';?> class="select2_group form-control " name="vreg_year" id="vreg_year"
