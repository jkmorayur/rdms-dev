                              ...
                              <div class="form-group">
                                   <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                        <?php if (($bookingDetails['vbk_status'] == vehicle_booked) && (check_permission('booking', 'allowconfirmbooking'))) { ?>
                                             <button value="<?php echo confm_book; ?>" name="status" type="submit" class="btn btn-success">Verify booking</button>
                                        ...
                                        <?php } if (check_permission('booking', 'allowcancelbooking')) { ?>
