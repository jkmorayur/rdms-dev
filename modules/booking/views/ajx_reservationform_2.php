<div class="popReservationForm_2 modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
     <div class="modal-dialog full-width" role="document" style="float: left;">
          <form class="modal-content frmReserveVehicle1" action="<?php echo site_url('booking/reserveVehicle'); ?>" enctype="multipart/form-data" method="post">
                                        ...
                                        <table class="table table-bordered" style="margin-bottom: 0px;">
                                             <tr>
                                                  ...
                                                  <td style="font-size: 25px;color: #1d73bd;font-weight: bold;
                                                      padding-top: 15px;padding-left: 60px;">Date : <?php echo date('d-m-Y'); ?></td>
                                             </tr>
                                             <tr>
                                                       ...
                                                       <tbody>
                                                            <tr>
                                                                 <td colspan="2">
                                                                      ...
                                                                      <input ype="text" class="form-control col-md-7 col-xs-12"
                                                                             name="bm[vbk_insurance_co]" id="mod_title" placeholder="Insurance Company"/>
                                                                 </td>

                                                                 <td colspan="2">
                                                                      <span class="small">Insurance Amount</span>
                                                                      <input type="text" class="txtInsuranceAmt form-control col-md-7 col-xs-12 decimalOnly" 
                                                                             value="0.00" name="bm[vbk_insurance_amt]" id="mod_title" placeholder="Insurance Amount"/>
                                                                 </td>
                                                                 <td>
                                                            ...
                                                            <tr>
                                                                 <td colspan="3">
                                                                      <span class="small" style="float:left;width: 100%;">Loan Select</span>
                                                                 ...
                                                                 <td>
                                                                      ...
                                                                      <input type="text" class="form-control col-md-7 col-xs-12 decimalOnly" 
                                                                             name="bm[vbk_loan_amt]" id="mod_title" placeholder="Loan Amount"/>
                                                                 </td>

                                                                 <td>
                                                                      <span class="small">Tenor</span>
                                                                      <input type="text" class="form-control col-md-7 col-xs-12 decimalOnly" 
                                                                             name="bm[vbk_tenor]" id="mod_title" placeholder="Tenor"/>
                                                                 </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                 ...
                                                                 <td colspan="3">
                                                                      ...
                                                                      <input type="text" class="txtChkAmt form-control col-md-7 col-xs-12 decimalOnly" 
                                                                             name="bm[vbk_chk_amt]" id="mod_title" placeholder="Cheque/Cash amount"/>
                                                                 </td>
                                                            </tr>

                                                            <tr>
                                                                 <td colspan="2">
                                                                      <span class="small" style="float:left;width: 100%;">Cheque bank</span>
                                                                 ...
                                                                 <td colspan="3">
                                                                      ...
                                                                      <input type="text" class="txtChkNum form-control col-md-7 col-xs-12" 
                                                                             name="bm[vbk_chk_num]" id="mod_title" placeholder="Cheque number"/>
                                                                 </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                 <td colspan="3">
                                                                      ...
                                                                      <input type="text" class="dtpDMY txtChkDate form-control col-md-7 col-xs-12" 
                                                                             name="bm[vbk_chk_date]" id="mod_title" placeholder="Cheque date"/>
                                                                 </td>
                                                                 
                                                                 <td colspan="3">
                                                                      <span class="small">Cheque holder</span>
                                                                      <input type="text" class="txtChkHolder form-control col-md-7 col-xs-12" 
                                                                             name="bm[vbk_chk_holder]" id="mod_title" placeholder="Account holder"/>
                                                                 </td>
                                                            </tr>
                                                       </tbody>
                                                  </table>
                                             ...
                                             <div>
                                                  <table class="table table-bordered">
                                                       <tbody>
                                                            ...
                                                            <tr>
                                                                 <td>Insurance</td>
                                                                 <td><input type="text" class="txtGrndInsurance form-control col-md-7 col-xs-12 decimalOnly" 
                                                                            name="" value="0.00" id="mod_title" placeholder="Insurance"/></td>
                                                            </tr>
                                                            <tr>
