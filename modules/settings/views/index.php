                    ...
                    <div class="x_content">
                         ...
                         <div class="" role="tabpanel" data-example-id="togglable-tabs">
                              <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist" style="background: none;">
                                   ...
                                   <li role="presentation">
                                        <a href="#app" id="dar-tab" role="tab" data-toggle="tab" aria-expanded="true">APP Settings</a>
                                   </li>
                                   <li role="presentation">
                                        <a href="#booking" id="dar-tab" role="tab" data-toggle="tab" aria-expanded="true">Booking</a>
                                   </li>
                                   <li role="presentation">
                                        <a href="#cronejob" id="dar-tab" role="tab" data-toggle="tab" aria-expanded="true">Crone job</a>
                                   </li>
                              </ul>
                              <div id="myTabContent" class="tab-content">
                                        ...
                                        <div class="row">
                                             <div class="col-md-6">
                                                  <div class="x_panel">
                                                       ...
                                                       <div class="x_content">
                                                            <div class="form-group">
                                                                 <label class="control-label col-md-3 col-sm-3 col-xs-12">Number of items in list</label>
                                                                 <div class="col-md-6 col-sm-6 col-xs-12">
                                                                      <input type="text" class="form-control col-md-7 col-xs-12" autocomplete="off"
                                                                           name="settings[pagination_limit]" id="mod_title" placeholder="Number of items in list"
                                                                           value="<?php echo get_settings_by_key('pagination_limit');?>"/>
                                                                 </div>
                                                            </div>
                                                            <div class="form-group">
                                                                 <label class="control-label col-md-3 col-sm-3 col-xs-12">Dashboard news</label>
                                                                 <div class="col-md-6 col-sm-6 col-xs-12">
                                                                      <textarea type="text" class="form-control col-md-7 col-xs-12" autocomplete="off"
                                                                                name="settings[dashboard_news]" id="mod_title" placeholder="Dashboard news"><?php echo get_settings_by_key('dashboard_news');?></textarea>
                                                                 </div>
                                                            </div>
                                                       </div>
                                                  </div>
                                                  ...
                                                  <div class="x_panel">
                                                       ...
                                                       <div class="x_content">
                                                            <div class="input-group">
                                                                 <label class="control-label col-md-12 col-sm-3 col-xs-12"><?php echo empty($downldcallstpend) ? 0 : $downldcallstpend; ?> pending VoxBay call record to download</label>
                                                                 <span class="input-group-btn">
                                                                      <a href="<?php echo site_url('settings/downloadpbxcalllist'); ?>" target="_blank"
                                                                               class="btn btn-primary go-class"><i class="fa fa-download"> Download</i></a>
                                                                 </span>
                                                            </div>
                                                       </div>
                                                  </div>
                                   ...
                                   <div role="tabpanel" class="tab-pane fade" id="followup" aria-labelledby="dar-tab">
                                        <div class="form-group">
                                             <label class="control-label col-md-3 col-sm-3 col-xs-12">Customer feedback for missed followup</label>
                                             <div class="col-md-6 col-sm-6 col-xs-12">
                                                  <input type="text" class="form-control col-md-7 col-xs-12" autocomplete="off"
                                                         name="settings[comn_foll_customer_feedback]" id="mod_title" placeholder="Customer feedback for missed followup"
                                                         value="<?php echo get_settings_by_key('comn_foll_customer_feedback');?>"/>
                                             </div>
                                        </div>
                                   </div>
                                   ...
                                   <div role="tabpanel" class="tab-pane fade" id="app" aria-labelledby="dar-tab">
                                        <div class="form-group">
                                             ...
                                             <div class="col-md-6 col-sm-6 col-xs-12">
                                                  <input type="text" class="form-control col-md-7 col-xs-12" autocomplete="off"
                                                         name="settings[app_android_version]" id="mod_title" placeholder="APP android version"
                                                         value="<?php echo get_settings_by_key('app_android_version');?>"/>
                                             </div>
                                        </div>
                                        <div class="form-group">
                                             ...
                                             <div class="col-md-6 col-sm-6 col-xs-12">
                                                  <input type="text" class="form-control col-md-7 col-xs-12" autocomplete="off"
                                                         name="settings[app_ios_version]" id="mod_title" placeholder="APP IOS version"
                                                         value="<?php echo get_settings_by_key('app_ios_version');?>"/>
                                             </div>
                                        </div>
                                        <div class="form-group">
                                             <label class="control-label col-md-3 col-sm-3 col-xs-12">IOS APP link (itunes)</label>
                                             <div class="col-md-6 col-sm-6 col-xs-12">
                                                  <input type="text" class="form-control col-md-7 col-xs-12" autocomplete="off"
                                                         name="settings[app_ios_link]" id="mod_title" placeholder="IOS APP link"
                                                         value="<?php echo get_settings_by_key('app_ios_link');?>"/>
                                             </div>
                                        </div>
                                        <div class="form-group">
                                             <label class="control-label col-md-3 col-sm-3 col-xs-12">IOS APP link (app store)</label>
                                             <div class="col-md-6 col-sm-6 col-xs-12">
                                                  <input type="text" class="form-control col-md-7 col-xs-12" autocomplete="off"
                                                         name="settings[app_ios_link_app_store]" id="mod_title" placeholder="IOS APP link"
                                                         value="<?php echo get_settings_by_key('app_ios_link_app_store');?>"/>
                                             </div>
                                        </div>
                                        <div class="form-group">
                                             ...
                                             <div class="col-md-6 col-sm-6 col-xs-12">
                                                  <input type="text" class="form-control col-md-7 col-xs-12" autocomplete="off"
                                                         name="settings[app_android_link]" id="mod_title" placeholder="Android APP link"
                                                         value="<?php echo get_settings_by_key('app_android_link');?>"/>
                                             </div>
                                        </div>
                                        <div class="form-group">
                                             ...
                                             <div class="col-md-6 col-sm-6 col-xs-12">
                                                  <input type="text" class="form-control col-md-7 col-xs-12" autocomplete="off"
                                                         name="settings[app_sms_signature]" id="mod_title" placeholder="App SMS Signature"
                                                         value="<?php echo get_settings_by_key('app_sms_signature');?>"/>
                                             </div>
                                        </div>
                                   </div>
                                   <div role="tabpanel" class="tab-pane fade" id="booking" aria-labelledby="dar-tab">
                                        ...
                                        <div class="form-group">
                                             <label class="control-label col-md-3 col-sm-3 col-xs-12">Booking open if not document submitted</label>
                                             <div class="col-md-6 col-sm-6 col-xs-12">
                                                  <input type="text" class="numOnly form-control col-md-7 col-xs-12" autocomplete="off"
                                                         name="settings[no_days_bk_opn_doc_submtd]" id="mod_title" placeholder="Booking open if not document submitted"
                                                         value="<?php echo get_settings_by_key('no_days_bk_opn_doc_submtd'); ?>"/>
                                             </div>
                                        </div>
                                        <div class="form-group">
                                             <label class="control-label col-md-3 col-sm-3 col-xs-12">Booking open if not loan submitted</label>
                                             <div class="col-md-6 col-sm-6 col-xs-12">
                                                  <input type="text" class="numOnly form-control col-md-7 col-xs-12" autocomplete="off"
                                                         name="settings[no_days_bk_loan_submtd]" id="mod_title" placeholder="Booking open if not loan submitted"
                                                         value="<?php echo get_settings_by_key('no_days_bk_loan_submtd'); ?>"/>
                                             </div>
                                        </div>
                                   </div>
                                   <div role="tabpanel" class="tab-pane fade" id="cronejob" aria-labelledby="dar-tab">
                                        <div class="form-group">
                                             <label class="control-label col-md-3 col-sm-3 col-xs-12">Prepare sitemap (Luxury)</label>
                                             <div class="col-md-6 col-sm-6 col-xs-12">
