                ...
                <div class="x_content">
                    <form action="<?php echo site_url('enquiry/pool'); ?>" method="get">
                        <table>
                            <tr>
                                <td>
                                    <input autocomplete="off" name="enq_pool_entry_date_from" type="text" class="dtpEnquiry form-control col-md-7 col-xs-12" placeholder="Pool date from" value="<?php echo isset($_GET['enq_pool_entry_date_from']) ? $_GET['enq_pool_entry_date_from'] : ''; ?>" />
                                </td>
                                <td style="padding-left: 10px;">
                                    <input autocomplete="off" name="enq_pool_entry_date_to" type="text" class="dtpEnquiry form-control col-md-7 col-xs-12" placeholder="Pool date to" value="<?php echo isset($_GET['enq_pool_entry_date_to']) ? $_GET['enq_pool_entry_date_to'] : ''; ?>" />
                                </td>
                                ...
                                <td>
                                    <select style="float: left;width: auto;" class="select2_group form-control" name="enq_status">
                                        <option value="0">All Status</option>
                                        <option <?php echo (isset($_GET['enq_status']) && $_GET['enq_status'] == '2') ? 'selected' : ''; ?> value="2">Request for drop</option>
                                        <option <?php echo (isset($_GET['enq_status']) && $_GET['enq_status'] == '3') ? 'selected' : ''; ?> value="3">Droped</option>
                                        <option <?php echo (isset($_GET['enq_status']) && $_GET['enq_status'] == '4') ? 'selected' : ''; ?> value="4">Request for lost</option>
                                        <option <?php echo (isset($_GET['enq_status']) && $_GET['enq_status'] == '5') ? 'selected' : ''; ?> value="5">Lost</option>
                                    </select>
                                </td>
                                <td style="padding-left: 10px;">
                            ...
                            <tbody>
                                ...
                                if (!empty($enquires)) {
                                    foreach ($enquires as $key => $value) {
                                        ...
                                        <tr data-url="<?php echo ($value['enq_current_status'] == 2 || $value['enq_current_status'] == 4) ? site_url('enquiry/viewVehicleStatus/' . encryptor($value['enq_id']) . '/' . $value['enq_current_status']) . '?p=' . $poolId : ''; ?>">
                                            ...
                                            <td> <a target="blank" <?php echo 'href="https://api.whatsapp.com/send?phone=' . $value['enq_cus_whatsapp'] . '"'; ?>>
                                                                                ...
                                                                                <td>
                                                                                    <select name="new_se_id" class="form-control col-md-7 col-xs-12" required>
                                                                                        ...
                                                                                        <?php foreach ($staffs as $skey => $stf) { ?>
                                                                                            <option value="<?php echo $stf['usr_id']; ?>">
