                                                  ...
                                                  <li>
                                                       <div class="block">
                                                            ...
                                                            ?><style>
                                                                 ...
                                                                 <div class="tags">
                                                                      <a data-url="<?php echo site_url('followup/getSingleFollowup') . '/' . encryptor($trackCard['enq_id']) . '/' . date('Y-m-d', strtotime($value['foll_next_foll_date'])); ?>" href="javascript:;" class="tagcolor<?php echo $value['foll_id']; ?> tag" min-date="<?php echo date('D M d Y', strtotime($value['foll_next_foll_date'])); ?>">
