                    ...
                    <div class="x_content">
                         ...
                         <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                   <input type="text" class="form-control col-md-7 col-xs-12" name="product[prd_regno_prt_1]" value="<?php echo isset($vehNo['0']) ? $vehNo['0'] : ''; ?>" maxlength="2" style="text-transform: uppercase;width: 49px;" required placeholder="KL" />

                                   <input type="text" class="numOnly form-control col-md-7 col-xs-12" name="product[prd_regno_prt_2]" value="<?php echo isset($vehNo['1']) ? $vehNo['1'] : ''; ?>" maxlength="2" style="text-transform: uppercase;width: 49px;" required placeholder="00" />

                                   <input type="text" class="form-control col-md-7 col-xs-12" name="product[prd_regno_prt_3]" value="<?php echo isset($vehNo['2']) ? $vehNo['2'] : ''; ?>" maxlength="3" style="text-transform: uppercase;width: 49px;" placeholder="AA" />

                                   <input type="text" class="numOnly form-control col-md-7 col-xs-12" name="product[prd_regno_prt_4]" value="<?php echo isset($vehNo['3']) ? $vehNo['3'] : ''; ?>" maxlength="4" style="text-transform: uppercase;width: 80px;" required placeholder="0000" />
                              </div>
                         </div>
                         ...
                         <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                   <select name="product[prd_brand]" id="prd_brand" class="form-control col-md-7 col-xs-12 bindToDropdown" data-dflt-select="Select Model" required data-url="<?php echo site_url('enquiry/bindModel'); ?>" data-bind="cmbModel">
                         ...
                         <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                   <select required class="select2_group form-control cmbVariant" name="product[prd_variant]" id="val_brand">
                                        <option>Select brand and model first</option>
                                   </select>
                              </div>
                         </div>
                         <div class="form-group">
                         ...
                         <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12" style="width: 50%;">
                                   <textarea placeholder="Design feature" class="form-control col-md-7 col-xs-12 editor1" name="product[prd_desc]"></textarea>
                              </div>
                         </div>
                         <?php if ($this->shrm == 1 || $this->uid == 100) { ?>
                              <div class="form-group">
                                   ...
                                   <div class="col-md-6 col-sm-6 col-xs-12" style="width: 50%;">
                                        <textarea placeholder="Safety feature" class="form-control col-md-7 col-xs-12 editor1" name="product[prd_safety_feture]"></textarea>
                                   </div>
                              </div>
                              ...
                              <div class="form-group">
                                   ...
                                   <div class="col-md-6 col-sm-6 col-xs-12" style="width: 50%;">
                                        <textarea placeholder="Comfort & Convenience feature" class="form-control col-md-7 col-xs-12 editor1" name="product[prd_cmfort_cnvnent_feture]"></textarea>
                                   </div>
                              </div>
                              <div class="form-group">
                                   <label class="control-label col-md-3 col-sm-3 col-xs-12">Warranty upto</label>
                                   <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" name="product[prd_warranty_upto]" class="form-control" id="prd_warranty_upto" placeholder="Warranty upto" />
                                   </div>
                              </div>
                              ...
                              <div class="form-group">
                                   ...
                                   <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" name="product[prd_arai_mileage]" class="numOnly form-control" id="prd_arai_mileage" placeholder="ARAI Mileage" />
                                   </div>
                              </div>
                              ...
                              <div class="form-group">
                                   ...
                                   <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" name="product[prd_acc_ftd]" class="form-control" id="prd_acc_ftd" placeholder="Accessories Fitted" />
                                   </div>
                              </div>
                              ...
                              <div class="form-group">
                                   ...
                                   <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" name="product[prd_or_road_price]" class="numOnly form-control" id="prd_or_road_price" placeholder="Current on road price" />
                                   </div>
                              </div>
                         <?php } ?>
                         <div class="form-group">
                         ...
                         <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                   <input type="text" name="product[prd_wrapp_color]" class="form-control col-md-7 col-xs-12" id="prd_wrapp_color" placeholder="Wrapp color" />
                              </div>
                         </div>
                         <div class="form-group">
                              <label class="control-label col-md-3 col-sm-3 col-xs-12">Km</label>
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                   <input type="text" name="product[prd_km_run]" class="numOnly form-control col-md-7 col-xs-12" id="prd_km_run" placeholder="Km" />
                              </div>
                         </div>
                         <div class="form-group">
                              <label class="control-label col-md-3 col-sm-3 col-xs-12">Insurance Validity</label>
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                   <input type="text" name="product[prd_insurance_validity]" class="dtpDatePickerEvaluation form-control col-md-7 col-xs-12" id="prd_insurance_validity" placeholder="Insurance Validity" />
                              </div>
                         </div>
                         <div class="form-group">
                              <label class="control-label col-md-3 col-sm-3 col-xs-12">Insurance IDV</label>
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                   <input type="text" name="product[prd_insurance_idv]" class="numOnly form-control col-md-7 col-xs-12" id="prd_insurance_idv" placeholder="Insurance IDV" />
                              </div>
                         </div>
                         <!-- <div class="form-group">
                         ...
                         <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                   <select required="true" style="width: 170px;" class="cmbFuel form-control col-md-7 col-xs-12" name="product[prd_fual]">
                         ...
                         <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                   <input type="text" placeholder="Price" class="numOnly form-control col-md-7 col-xs-12" name="product[prd_price]" />
                              </div>
                         </div>
                         ...
                         <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                   <input type="text" name="product[prd_mileage]" class="numOnly form-control col-md-7 col-xs-12" id="prd_mileage" placeholder="Mileage" />
                              </div>
                         </div>
                         ...
                         <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                   <input type="text" name="product[prd_owner]" class="form-control col-md-7 col-xs-12" id="prd_owner" placeholder="Owner" />
                              </div>
                         </div>
                         ...
                         <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                   <input type="text" name="product[prd_engine_cc]" class="numOnly form-control col-md-7 col-xs-12" id="prd_engine_cc" placeholder="Engine in cc" />
                              </div>
                         </div>
                         ...
                         <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                   <input value="1" type="checkbox" name="product[prd_new_arrivals]" class="" id="prd_new_arrivals" placeholder="Model" />
                              </div>
                         </div>
                         <!-- -->
                         <div class="form-group">
                                             ...
                                             <div class="span4">
                                                  <div class="form-group no-margin-bot">
                                                       <div class=" col-md-6 col-sm-6 col-xs-12-row">
                                                            <input type="checkbox" class="input-block-level" name="features[<?php echo $value['ftr_id']; ?>]" value="1" style="margin-right: 10px;margin-top: -4px;" /><?php echo $value['ftr_feature']; ?>
                                                       </div>
                                                  </div>
                                             </div>
                                        </div>
