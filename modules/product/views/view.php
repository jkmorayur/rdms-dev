                    ...
                    <div class="x_content">
                         ...
                         <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                   <input readonly type="text" class="form-control" name="product[prd_number]" id="prd_number" value="<?php echo !empty($productsDetails['product_details']['prd_number']) ?
                         ...
                         <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                   <input type="text" class="form-control col-md-7 col-xs-12" name="product[prd_regno_prt_1]" value="<?php echo $productsDetails['product_details']['prd_regno_prt_1']; ?>" maxlength="2" style="text-transform: uppercase;width: 49px;" required placeholder="KL" />

                                   <input type="text" class="form-control col-md-7 col-xs-12 numOnly" name="product[prd_regno_prt_2]" value="<?php echo $productsDetails['product_details']['prd_regno_prt_2']; ?>" maxlength="2" style="text-transform: uppercase;width: 49px;" required placeholder="00" />

                                   <input type="text" class="form-control col-md-7 col-xs-12" name="product[prd_regno_prt_3]" value="<?php echo $productsDetails['product_details']['prd_regno_prt_3']; ?>" maxlength="3" style="text-transform: uppercase;width: 49px;" placeholder="AA" />

                                   <input type="text" class="form-control col-md-7 col-xs-12 numOnly" name="product[prd_regno_prt_4]" value="<?php echo $productsDetails['product_details']['prd_regno_prt_4']; ?>" maxlength="4" style="text-transform: uppercase;width: 80px;" required placeholder="0000" />
                              </div>
                         </div>
                                   ...
                                   <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select required name="product[prd_location]" class="select2_group form-control" placeholder="Color">
                                             ...
                                             <?php foreach ($location as $key => $value) { ?>
                                                  <option <?php echo ($value['shr_id'] == $productsDetails['product_details']['prd_location']) ? "selected='selected'" : ''; ?> value="<?php echo $value['shr_id']; ?>"><?php echo $value['shr_location']; ?>
                                                  </option>
                                             <?php } ?>
                                        </select>
                                   </div>
                         ...
                         <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                   <select name="product[prd_brand]" id="prd_brand" class="form-control col-md-7 col-xs-12 bindToDropdown" data-dflt-select="Select Model" required data-url="<?php echo site_url('enquiry/bindModel'); ?>" data-bind="cmbModel">
                                        ...
                                        ?>
                                                  <option <?php echo ($productsDetails['product_details']['prd_brand'] == $value['brd_id']) ? "selected='selected'" : ''; ?> value="<?php echo $value['brd_id']; ?>"><?php echo $value['brd_title']; ?></option>
                                        <?php
                                             }
                                        }
                                        ?>
                         ...
                         <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                   <select required data-url="<?php echo site_url('enquiry/bindVarient'); ?>" data-bind="cmbVariant" data-dflt-select="Select Variant" class="cmbModel select2_group form-control bindToDropdown" name="product[prd_model]" id="val_brand">
                                        ...
                                        ?>
                                                  <option <?php echo ($productsDetails['product_details']['prd_model'] == $value['mod_id']) ? "selected='selected'" : ''; ?> value="<?php echo $value['mod_id']; ?>"><?php echo $value['mod_title']; ?></option>
                                        <?php
                                             }
                                        }
                                        ?>
                         ...
                         <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                   <select required class="select2_group form-control cmbVariant" name="product[prd_variant]" id="val_brand">
                                        ...
                                        ?>
                                                  <option <?php echo ($productsDetails['product_details']['prd_variant'] == $value['var_id']) ? "selected='selected'" : ''; ?> value="<?php echo $value['var_id']; ?>"><?php echo $value['var_variant_name']; ?>
                                                  </option>
                                        <?php
                                             }
                                        }
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                   ...
                                   <select name="product[prd_year]" class="select2_group form-control" placeholder="Year of registered">
                                        ...
                                        <?php for ($i = date('Y') - 30; $i <= date('Y'); $i++) { ?>
                                             <option <?php echo ($productsDetails['product_details']['prd_year'] == $i) ? "selected='true'" : ''; ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                        <?php } ?>
                                   </select>
                              </div>
                         </div>
                         <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                   ...
                                   <select name="product[prd_color_id]" class="select2 select2_group form-control" placeholder="Color">
                         ...
                         <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                   <input value="<?php echo $productsDetails['product_details']['prd_km_run']; ?>" type="text" name="product[prd_km_run]" class="numOnly form-control" id="prd_km_run" placeholder="Km" />
                              </div>
                         </div>
                         <div class="form-group">
                              <label class="control-label col-md-3 col-sm-3 col-xs-12">Insurance Validity</label>
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                   <input value="<?php echo $productsDetails['product_details']['prd_insurance_validity']; ?>" type="text" name="product[prd_insurance_validity]" class="dtpDatePickerEvaluation form-control" id="prd_insurance_validity" placeholder="Insurance Validity" />
                              </div>
                         </div>
                         <div class="form-group">
                              <label class="control-label col-md-3 col-sm-3 col-xs-12">Insurance IDV</label>
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                   <input type="text" value="<?php echo $productsDetails['product_details']['prd_insurance_idv']; ?>" name="product[prd_insurance_idv]" class="numOnly form-control col-md-7 col-xs-12" id="prd_insurance_idv" placeholder="Insurance IDV" />
                              </div>
                         </div>
                         <!-- <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                   <select required="true" style="width: 170px;" class="cmbFuel form-control col-md-7 col-xs-12" name="product[prd_fual]">
                                        <?php foreach (unserialize(FUAL) as $key => $value) { ?>
                                             <option <?php echo ($productsDetails['product_details']['prd_fual'] == $key) ? "selected='selected'" : ''; ?> value="<?php echo $key; ?>"><?php echo $value; ?></option>
                                        <?php } ?>
                                   </select>
                              </div>
                         </div>
                         ...
                         <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                   <input value="<?php echo $productsDetails['product_details']['prd_owner']; ?>" type="text" name="product[prd_owner]" class="numOnly form-control" id="prd_owner" placeholder="Owner" />
                              </div>
                         </div>
                         ...
                         <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                   <input value="<?php echo $productsDetails['product_details']['prd_engine_cc']; ?>" type="text" name="product[prd_engine_cc]" class="numOnly form-control" id="prd_engine_cc" placeholder="Engine in cc" />
                              </div>
                         </div>
