                         ...
                         <form action="<?php echo $fullURL; ?>" method="get">
                              <table>
                                   <tr>
                                        ...
                                        <td style="padding-left: 10px;">
                                             <select style="float: left;width: auto;" class="select2_group form-control" name="mode">
                                                  ...
                                                  <?php foreach (unserialize(MODE_OF_CONTACT) as $sts => $stsName) {?> 
                                                       <option <?php echo (isset($_GET['mode']) && ((int) $sts == (int) $_GET['mode'])) ? 'selected="selected"' : '';?>
                                        ...
                                        <td style="padding-left: 10px;">
                                             <input autocomplete="off" name="enh_added_on_from" type="text" class="dtpEnquiry form-control col-md-7 col-xs-12" 
                                                    placeholder="Date from" value="<?php echo isset($_GET['enh_added_on_from']) ? $_GET['enh_added_on_from'] : ''; ?>"/>
                                        </td>
                                        
                                        <td style="padding-left: 10px;">
                                             <input autocomplete="off" name="enh_added_on_to" type="text" class="dtpEnquiry form-control col-md-7 col-xs-12" 
                                                    placeholder="Date to" value="<?php echo isset($_GET['enh_added_on_to']) ? $_GET['enh_added_on_to'] : ''; ?>"/>
                                        </td>

                                        <td style="padding-left: 10px;">
                                             <input autocomplete="off" name="searchValue" type="text" class="form-control col-md-7 col-xs-12" 
                                                    placeholder="Search Value" value="<?php echo isset($_GET['searchValue']) ? $_GET['searchValue'] : ''; ?>"/>
                                        </td>
