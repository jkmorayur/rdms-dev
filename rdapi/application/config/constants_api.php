...
define('FILE_READ_MODE', 0777);
define('FILE_WRITE_MODE', 0777);
define('DIR_READ_MODE', 0777);
define('DIR_WRITE_MODE', 0777);
...
define('EMAIL_CAREER', 'teleclt@royaldrive.in');
define('MAIL_FROM_NAME', 'Royaldrive');

define('STATIC_TITLE', ' royaldrive');
...
define('FUAL', serialize(array(
  array('ful_id' => 1, 'ful_title' => 'Petrol'), array('ful_id' => 2, 'ful_title' => 'Diesel'), array('ful_id' => 3, 'ful_title' => 'Gas'),
