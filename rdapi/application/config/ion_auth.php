<?php
  ...
  $config['tables_api']['users'] = TABLE_PREFIX_PORTAL . 'users';
  $config['tables_api']['groups'] = TABLE_PREFIX_PORTAL . 'groups';
  $config['tables_api']['users_groups'] = TABLE_PREFIX_PORTAL . 'users_groups';
  $config['tables_api']['login_attempts'] = TABLE_PREFIX_PORTAL . 'login_attempts';
  $config['tables_api']['user_access'] = TABLE_PREFIX_PORTAL . 'user_access';//added
  ...
  $config['identity_api'] = 'usr_email';               // A database column which is used to login with
