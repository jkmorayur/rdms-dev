<?php
  ...
  class dashboard_model extends CI_Model {
       ...
       function countTotalEnquires() {
            ...
            $analysis['stock_vehicle'] = $this->db->query("SELECT COUNT(*) AS vehicle_count FROM " . $this->tbl_valuation . ' WHERE val_status = ' . vehicle_evaluated . ' AND (val_type = 1 OR val_type = 2)')->row()->vehicle_count;
            ...
            if (is_roo_user()) {
                 ...
                 $analysis['deleted_vehicles'] = $this->db->where_in($this->tbl_enquiry . '.enq_se_id', $mystaffs)
                    ->where($this->tbl_enquiry . '.enq_current_status', 99)->count_all_results($this->tbl_enquiry, false);
