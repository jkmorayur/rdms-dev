                         ...
                         <form id="demo-form2" method="post" action="<?php echo site_url($controller . '/add');?>" data-parsley-validate class="form-horizontal form-label-left frmEmployee" enctype="multipart/form-data">
                              ...
                              <div class="form-row">
                                   <div class="form-group col-md-4">
                                        ...
                                        <select required class="form-control bindToDropdown" name="usr_group" 
                              ...
                              <div class="form-row">
                                   ...
                                   <div class="form-group col-md-4">
                                        ...
                                        <input type="text" id="last-name" name="usr_phone" required="required" data-past=".usr_whatsapp" 
                                               class="form-control">
                                   </div>
                                   <div class="form-group col-md-4">
                                        <label for="inputEmail4">Whatsapp <span class="required">*</span></label>
                                        <input type="text" id="last-name" name="usr_whatsapp" required="required" 
                              ...
                              <div class="form-row">
                                   ...
                                   <div class="form-group col-md-4">
                                        ...
                                        <input type="text" id="usr_password_conf" name="usr_password_conf" required="required" 
