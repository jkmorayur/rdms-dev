               ...
               <div class="x_panel">
                    ...
                    <div class="x_content">
                         ...
                         $msgWithtPrice = $message = '🚘 Vehicle : ' . $product_details['brd_title'] . '%0a' .
                                 ...
                                 '📶 https://www.royaldrive.in, https://www.royaldrivesmart.in %0a' .
                                 '📞 +91 812990 9090 %0a' .
                                 '🌐 ' . $url. ' %0a'.
                                 '🌐  https://cust.royaldrive.in/rd-app-qr';

                         if (($product_details['prd_rd_mini'] != 1) && ($product_details['prd_price'] > 0) && ($product_details['prd_show_price'] == 1)) {//Luxury
                              $message = $message . '%0a%0a RD PRICE : *' . inr_currency_format($product_details['prd_price']) . '*';
                         }
                         ?>
                                        ...
                                        <div class="x_title">
                                             ...
                                             <ul class="nav navbar-right panel_toolbox">
                                                  <li style="float: right;">
                                                       <a title="Download spec" target="_blank" href="<?php echo site_url('product/downloadspec/' . $product_details['prd_id']); ?>">
                                                            <img width="20" title="Export to excel" src="images/pdf.png"/>
                                                       </a>
                                                  </li>
                                                  <li>
                                                       <a title="Share on whatsapp" style="color: green;" target="_blank" href="https://api.whatsapp.com/send/?text=<?php echo $message; ?>">
                                                            <i style="font-size: 23px;" class="fa fa-whatsapp"></i>
                                                       </a>
                                                  </li>
                                                  <?php if (check_permission('product', 'view')) { ?>
                                                       <li>
                                                            <a title="Update product" style="color: green;" target="_blank" href="<?php echo site_url('product/view/' . $product_details['prd_id']); ?>">
                                                                 <i style="font-size: 23px;" class="fa fa-pencil-square-o"></i>
                                                            </a>
                                                       </li>
                                                  <?php } if (check_permission('product', 'index')) { ?>
                                                       <li>
                                                            <a title="List product" style="color: green;" target="_blank" href="<?php echo site_url('product'); ?>">
                                        ...
                                        <div class="x_content">
                                             <div>
                                                  ...
                                                  if ($product_details['prd_rd_mini'] == 1) {
                                                       ...
                                                       echo '<br><br> RD PRICE : *' . inr_currency_format($product_details['prd_price']) . '*';
                                                  } else {
                                                       echo str_replace('%0a', '<br>', $message);
                                                  }
                                                  ?>
                                             ...
                                             <?php if(check_permission('product', 'update')) { ?>
                                                  <div style="background: #ece8e8;float: left;width: 100%;margin-top: 20px;padding: 13px 6px 6px 6px;">
                                                       <div class="form-group">
                                                            <label for="enq_cus_test_drive" style="font-size: 18px;" class="control-label col-md-8 col-sm-6 col-xs-12">
                                                                 Please verify to publish website
                                                            </label>
                                                            <div class="col-md-4 col-sm-6 col-xs-12">
                                                                 <input for="status" data-url="<?php echo site_url('product/changesCheckBoxFields/prd_status/' . $product_details['prd_id']) ?>" 
                                                                      class="js-switch chkStatus" type="checkbox" name="chkStatus" value="<?php echo $product_details['prd_status']; ?>" 
                                   ...
                                   <div class="col-md-6 col-sm-6">
                                        <div class="x_panel tile">
                                             <div class="x_title">
                                                  ...
                                                  <ul class="nav navbar-right panel_toolbox">
                                                       <li style="float: right;">
                                                            <i style="font-size: 23px;" class="fa fa-copy btnCoppy" data-section=".divShareGoogle"></i>
                                                       </li>
                                                  </ul>
                                                  <div class="clearfix"></div>
                                             </div>
                              ...
                              <div class="col-md-6 col-sm-6">
                                   <div class="x_panel tile">
                                        <div class="x_title">
                                             ...
                                             <ul class="nav navbar-right panel_toolbox">
                                                  <li style="float: right;">
                                                       <a title="Download all images" style="color: green;" target="_blank" href="<?php echo site_url('product/downloadimagezip/' . encryptor($product_details['prd_id'])); ?>">
