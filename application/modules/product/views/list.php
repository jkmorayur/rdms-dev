                    ...
                    <table id="datatable1" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr data-url="<?php echo site_url('product/view/' . $value['prd_id']); ?>">
                                ...
                                <td class="trVOE" alt="<?php echo $value['prd_id']; ?>">
                                ...
                                <td class="trVOE">
                                    <?php
                                                       ...
                                                       echo img(array('src' => 'https://royaldrive.s3.ap-south-1.amazonaws.com/products/380X238_' . $img, 'alt' => $value['prd_name'], 'width' => '50'));
                                                       ?>
                                </td>
                                <td class="trVOE">
                                ...
                                <?php if ($this->uid = 100) {
                                                       $sameColor = (strtolower(trim($value['prd_color'])) == strtolower(trim($value['vc_color']))) ? 'style="background:#EBF8A4;color:#000"' : '';
                                                  ?>
                                <td <?php echo $sameColor; ?>><?php echo $value['prd_color']; ?></td>
                                <td <?php echo $sameColor; ?>><?php echo $value['vc_color']; ?></td>
                                <?php } ?>
