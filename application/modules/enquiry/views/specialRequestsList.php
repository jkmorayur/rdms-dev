                         ...
                         <ul class="nav navbar-right panel_toolbox">
                              <li style="float: right;">
                                   <?php if (check_permission('enquiry', 'export_excel')) { ?>
                                        <a href="<?php echo site_url('enquiry/exportExcelStatus/' . $status . '?' . $_SERVER['QUERY_STRING']); ?>">
                    ...
                    <div class="x_content">
                         <form action="<?php echo site_url('enquiry/changeStatusRequest/' . $status); ?>" method="get">
                              <table>
                                   <tr>
                                        <td>
                                             <input autocomplete="off" name="enq_date_from" type="text" class="dtpEnquiry form-control col-md-7 col-xs-12" placeholder="Date from" value="<?php echo isset($enq_date_from) ? $enq_date_from : ''; ?>" />
                                        </td>
                                        <td style="padding-left: 10px;">
                                             <input autocomplete="off" name="enq_date_to" type="text" class="dtpEnquiry form-control col-md-7 col-xs-12" placeholder="Date to" value="<?php echo isset($enq_date_to) ? $enq_date_to : ''; ?>" />
                                        </td>
                                        ...
                                        <td style="padding-left: 10px;">
                                             <input type="text" placeholder="Search value" style="float: left;width: auto;" class="form-control" name="keysearch" value="<?php echo isset($_GET['keysearch']) ? $_GET['keysearch'] : ''; ?>" />
                                        </td>
                         ...
                         <table id="tblSpecialReq" class="table table-striped table-bordered display nowrap" style="width:100%;white-space: nowrap;">
                              <thead>
                                   <tr>
                                        <th>Customer ID</th>
                                        <th>Customer</th>
                              ...
                              <tbody>
                                   ...
                                   ?>
                                             <tr data-url="<?php echo site_url('enquiry/viewVehicleStatus/' . encryptor($value['enq_id']) . '/' . $status); ?>">
                                                  ...
                                                  <td class="trVOE"><?php echo isset($vehDetails['0']['veh_color']) ? $vehDetails['0']['veh_color'] : ''; ?></td>
                                                  <td class="trVOE"><?php echo isset($vehDetails['0']['veh_exch_cus_expect']) ? $vehDetails['0']['veh_exch_cus_expect'] : ''; ?></td>
                                                  ...
                                                  <td><?php echo !empty($value['enq_home_visit_date']) ? date('j M Y', strtotime($value['enq_home_visit_date'])) : ''; ?></td>
                                                  <td><?php echo isset($value['enq_last_foll_cust_rmk']) ? $value['enq_last_foll_cust_rmk'] : ''; ?></td>
                                                  <td><?php echo $value['enq_sm_rmk']; ?></td>
                                                  <td><?php echo $value['enq_asm_rmk']; ?></td>
                                                  <td><?php echo $value['enq_mis_rmk']; ?></td>
                                                  <td><?php echo !empty($value['enq_added_on']) ? date('j M Y', strtotime($value['enq_added_on'])) : ''; ?></td>
                                                  <td><?php echo isset($cntMods[$value['enq_mode_enq']]) ? $cntMods[$value['enq_mode_enq']] : ''; ?></td>
                         ...
                         <div class="col-md-4 col-sm-4 col-xs-12">
                              <div class="x_panel tile fixed_height_320" style="overflow: scroll;">
                                   ...
                                   <div class="dashboard-widget-content">
                                        <div class="x_content">
                                             <form class="frmQuickAssign" data-url="<?php echo site_url('enquiry/submitReAssign'); ?>" method="get">
                                                  ...
                                                  <table>
                                                       ...
                                                       <tr>
                                                            <td style="padding:10px;">
                                                                 ...
                                                                 <textarea placeholder="Desction" name="desc" class="select2_group form-control" required><?php echo $title . ', ' . $enq_date_from_se . $enq_date_to_se; ?></textarea>

                                                            </td>
                                                       </tr>
                                                       <tr>
                                                            <td style="padding-left: 10px;"> <button type="submit" class="btn btn-round btn-primary">Assign</button></td>
                                                       </tr>
                                                  </table>
                                             </form>
                                        </div>
