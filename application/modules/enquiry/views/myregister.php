                              ...
                              <div class="x_panel">
                                   <div class="x_title">
                                        ...
                                        <ul class="nav navbar-right panel_toolbox">
                                             ...
                                             <li style="float:right;"><a data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample"><i class="fa fa-chevron-up"></i>
                                        ...
                                        <?php if (check_permission('enquiry', 'myregisterassignaddedfilter')) { ?>
                                             <td>
                                                  <select class="select2_group form-control enq_se_id" name="vreg_assigned_to">
                                                       ...
                                                       <option value="<?php echo $this->uid; ?>"><?php echo $this->session->userdata('usr_username'); ?></option>
                                                                                                                        ...
                                                                                                                        <div class="form-group" style="width: 100%;float: left;">
                                                                                                                             ...
                                                                                                                             <div class="col-md-6 col-sm-6 col-xs-12">
                                                                                                                                  <select required class="select2_group form-control cmbContactMode" name="regfoll[regf_reson]" id="vreg_contact_mode">
                                                                                                                                       ...
                                                                                                                                       <option value="150">Call attended</option>
                                                                                                                                  </select>
                                                                                                                             </div>
                                                                                                                        </div>
