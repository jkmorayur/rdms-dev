...
class enquiry_model extends CI_Model
{
     ...
     { //enquires_rl
          ...
          if (!empty($id)) {
               ...
               if (is_roo_user()) {
                    ...
                    ////                                      ->get($this->viewk_enquiry_vehicle_master)->row()->enq_id;
                    //
                    //                      if (!empty($exclude)) {
                    ...
                    //                                      ->get($this->viewj_enquiry_vehicle_master)->row()->enq_id;
     ...
     { //cpd to api 17171
          ...
          $selectArray = array(
               ...
               $this->tbl_register_master . '.vreg_tsc_comments', $this->tbl_register_master . '.vreg_added_on',
               $this->tbl_register_master . '.vreg_cust_name', $this->tbl_register_master . '.vreg_cust_phone',
               $this->tbl_register_master . '.vreg_email', $this->tbl_register_master . '.vreg_cust_place',
               $this->tbl_register_master . '.vreg_existing_vehicle', $this->tbl_register_master . '.vreg_occupation',
               ...
               $this->tbl_register_master . '.vreg_investment', $this->tbl_register_master . '.vreg_km',
               $this->tbl_register_master . '.vreg_customer_status', $this->tbl_register_master . '.vreg_type_of_visit',
               $this->tbl_register_master . '.vreg_tsc_comments', $this->tbl_register_master . '.vreg_appointment',
               $this->tbl_register_master . '.vreg_second_d_hpy_cal', $this->tbl_register_master . '.vreg_second_d_hpy_cal',
               $this->tbl_register_master . '.vreg_division', $this->tbl_register_master . '.vreg_showroom',
               $this->tbl_register_master . '.vreg_call_type', $this->tbl_register_master . '.vreg_event',
               $this->tbl_register_master . '.vreg_is_effective', $this->tbl_register_master . '.vreg_entry_date',
               $this->tbl_register_master . '.vreg_is_punched', $this->tbl_register_master . '.vreg_customer_remark',
               $this->tbl_register_master . '.vreg_inquiry', $this->tbl_register_master . '.vreg_is_verified',
               $this->tbl_register_master . '.vreg_next_followup', $this->tbl_register_master . '.vreg_cust_place',
               $this->tbl_register_master . '.vreg_referal_type', $this->tbl_register_master . '.vreg_referal_name',
               $this->tbl_register_master . '.vreg_referal_phone', $this->tbl_register_master . '.vreg_last_action',
     ...
     { //debug($data['proc_purchase_prd']);
          // debug($data['enquiry']['enq_se_id']);
          $showroom = get_logged_user('usr_showroom');
          for ($i = 0; $i < $noOfSale; $i++) {
               //debug($data);
               //debug($data,1);
     ...
     function poolBatch($batchId = 0)
     {
          ...
          if (!empty($batchId)) {
               $select = array(
                    'enq_pool_batch', 'enp_cmd_assign', 'enp_added_on', 'enp_added_by', $this->tbl_users . '.usr_username', 'enp_updated_on',
                    'enp_cmd_updates', 'updby.usr_username AS usr_upd_username, sefrm.usr_username AS usr_from_username, enq_cus_name, enq_cus_mobile,'
