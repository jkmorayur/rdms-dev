                              ...
                              <div class="form-horizontal form-label-left">
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <select class="select2_group form-control select2" name="trk_vehicle_no" required="required">
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <select class="select2_group form-control cmbSearchList" name="trk_out_pass_rd_driver" required="required"
