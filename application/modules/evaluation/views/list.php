...
<script>
     ...
     function valuationList(canDelete, frmData) {
          var canShow = <?php echo (!check_permission('evaluation', 'hidecustomerdetails')) ? 'true' : 'false' ?>;
          var canShowRefurb = <?php echo (check_permission('evaluation', 'showrefurbcostndndexportexcel')) ? 'true' : 'false' ?>;
