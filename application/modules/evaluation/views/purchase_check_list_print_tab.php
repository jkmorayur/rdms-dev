    ...
    <div class="page" id="printDiv">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <a href="<?php echo site_url('evaluation/edit_purchase_check_list/1/' . $result["masterData"]["pcl_val_id"]) . '/' . $result['masterData']['pcl_check_list_id'] ?>"
                    class="btn btn-info no-print" id="edit_btn" style="float: right;"><i class="fa fa-edit"
