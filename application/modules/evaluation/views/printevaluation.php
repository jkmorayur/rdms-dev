                    ...
                    <div id="myTabContent" class="tab-content">
                                    ...
                                    <table class="table table-striped">
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th><?php echo date('d-m-Y', strtotime($vehicles['val_valuation_date'])); ?>
                                                </th>
                                            </tr>
                                        </thead>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="refurbisheReq_3-tab"
                            ...
                            <div class="page" id="printRefrb">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="x_panel">
                                        <button type="submit" class="btn btn-info no-print" id="printBtn_rfrb"><i
                                                class="fa fa-print" style="color:white"></i> Print</button>
                                        <a href="<?php echo site_url('evaluation/refurbisheReturn/' . encryptor($vehicles["val_id"])); ?>"
                                            ...
                                            style="float: right;"><i class="fa fa-edit" style="color:White"></i>
                                            Edit</a>
                                        <div class="x_content">
                                    ...
                                    <div class="row">
                                        <form action="<?php echo site_url('checklist/add_purchase_check_list'); ?>"
                                            method="post" class="x_content frmNewValuation" id="chk_list_form"
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <table class="tabled table-striped refrftable">
                                                        ...
                                                        <tr>
                                                            <td><?php echo $slno++ ?></td>
                                                            <td class="no-print"><?php echo $value->upgrd_added_on; ?>
                                                            </td>
                                                            <td style="white-space: normal;">
                                                                <?php echo $value->upgrd_key . $addedBy; ?></td>
                                                            <td><?php echo get_in_currency_format($value->upgrd_value); ?>
                                                            </td>
                                                            <td style="white-space: normal;">
                                                                <?php echo $value->actual_job_description; ?></td>
                                                            <td><?php echo ($value->upgrd_refurb_actual_cost > 0) ? get_in_currency_format($value->upgrd_refurb_actual_cost) : ''; ?>
                                                            </td>
                                                            <td style="white-space: normal;">
                                                                <?php echo $value->upgrd_refurb_remarks; ?></td>
                                                        </tr>
                                                        <?php
                                                                                }
                                                                           }
