<?php $stockNumber = !empty($evaluation_details['val_stock_num']) ? 'Stock Number :- ' . $evaluation_details['val_stock_num'] :
    $evaluation_details['div_short_code'] . 'KL' . date('Ym') . generate_vehicle_virtual_id($evaluation_details['val_id']);
?>
<div class="row">
    <!--  print div-->
                ...
                <div class="x_content">
                    <div class="chk-container" style="float: left;width: 100%;">
                        <h3 class="border-bottom border-gray pb-2 text-center">
                            ...
                            <p style="float:right;font-size: 10px;"><?php echo $stockNumber; ?></p>
                        </h3>
