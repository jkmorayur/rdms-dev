     ...
     <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
               <div class="x_panel">
                    ...
                    <div class="x_content">
                         <br />
                         <?php echo form_open_multipart("veh_variant/update", array('id' => "frmVehicleModel", 'class' => "form-horizontal form-label-left"))?>
                                        ...
                                        <?php
                                          if (!empty($brands)) {
                                               foreach ($brands as $key => $value) {
                                                    ?>
                                                    <option value="<?php echo $value['brd_id'];?>" <?php echo ($value['brd_id'] == $car['var_brand_id']) ? "selected='true'" : '';?>><?php echo $value['brd_title'];?></option>
                                                    <?php
                                               }
                                          }
                                        ?>
                                             ...
                                             <?php
                                               if (!empty($model)) {
                                                    foreach ($model as $key => $value) {
                                                         ?>
                                                         <option value="<?php echo $value['mod_id'];?>" <?php echo ($value['mod_id'] == $car['var_model_id']) ? "selected='true'" : '';?>><?php echo $value['mod_title'];?></option>
                                                         <?php
                                                    }
                                               }
                                             ?>
