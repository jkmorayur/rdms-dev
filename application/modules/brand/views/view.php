     ...
     <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
               <div class="x_panel">
                    ...
                    <div class="x_content">
                         <br />
                         <?php echo form_open_multipart("brand/update", array('id' => "frmBrand", 'class' => "form-horizontal form-label-left"))?>
...
//                                }
                         ...
                         <div class="form-group">
                              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Brand Title <span class="required">*</span></label>
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                   <input required="true" value="<?php echo $brand['brd_title'];?>" type="text" class="form-control col-md-7 col-xs-12" name="brd_title" id="brd_title" placeholder="Brand Title"/>
                              </div>
                         </div>
                         <!--                    <div class="form-group">
