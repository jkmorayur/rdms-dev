                         ...
                         <form method="post" action="<?php echo site_url('booking/editBooking'); ?>" class="form-horizontal form-label-left"  enctype="multipart/form-data">
                                   ...
                                   <tbody>
                                        <tr>
                                             <td colspan="2">
                                                  ...
                                                  Insurance validity : <input type="text" class="dtpDatePickerDMY" name="bm[vbk_insurance_valid_upto]"/>
                                             </td>
                                             <td>
                                                  Insurance Amount : <input type="text" value="<?php echo $bookingDetails['vbk_insurance_amt']; ?>" name="bm[vbk_insurance_amt]"/> 
                                             </td>
                                             <td>IDV : <input type="text" value="<?php echo $bookingDetails['vbk_insurance_idv']; ?>" name="bm[vbk_insurance_idv]"/> </td>
                                        </tr>
                                   ...
                                   <table class="table table-bordered">
                                        <tbody>
                                             <tr>
                                                  ...
                                                  <td>
                                                       <input type="text" value="<?php echo $bookingDetails['vbk_vehicle_amt']; ?>" name="bm[vbk_vehicle_amt]"/>
                                                  </td>
                                             </tr>
                                             <tr>
                                                  <td>
                                                  ...
                                                  <td>
                                                       <input type="text" value="<?php echo $bookingDetails['vbk_tcs']; ?>" name="bm[vbk_tcs]"/>
                                                  </td>
                                             </tr>
                                             <tr>
                                                  <td>RTO Transfer &amp; Service Charge</td>
                                                  <td>
                                                       <input type="text" value="<?php echo $bookingDetails['vbk_rto_charges']; ?>" name="bm[vbk_rto_charges]"/>
                                                  </td>
                                             </tr>
                                             <tr>
                                                  <td>Refurbishment Charge</td>
                                                  <td>
                                                       <input type="text" value="<?php echo $bookingDetails['vbk_refurbish_cost']; ?>" name="bm[vbk_refurbish_cost]"/>
                                                  </td>
                                             </tr>
                                             <tr>
                                                  <td>Accessories Charge</td>
                                                  <td>
                                                       <input type="text" value="<?php echo $bookingDetails['vbk_accessories_cost']; ?>" name="bm[vbk_accessories_cost]"/>
                                                  </td>
                                             </tr>
                                             <tr>
                                                  <td>Total Sales Amount</td>
                                                  <td>
                                                       <input type="text" value="<?php echo $bookingDetails['vbk_ttl_sale_amt']; ?>" name="bm[vbk_ttl_sale_amt]"/>
                                                  </td>
                                             </tr>
                                             <tr>
                                                  <td>Advance Amount</td>
                                                  <td>
                                                       <input type="text" value="<?php echo $bookingDetails['vbk_advance_amt']; ?>" name="bm[vbk_advance_amt]"/>
                                                  </td>
                                             </tr>
                                             <tr>
                                                  <td>Balance Amount</td>
                                                  <td>
                                                       <input type="text" value="<?php echo $bookingDetails['vbk_balance']; ?>" name="bm[vbk_balance]"/>
                                                  </td>
                                             </tr>
                                        </tbody>
                                   </table>
                              ...
                              <div class="form-group">
                                   ...
                                   <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" class="dtpEnquiry form-control col-md-7 col-xs-12" name="bm[vbk_delivery_date]" 
                                               autocomplete="off" id="vbk_delivery_date" placeholder="Delivery date"/>
                                   </div>
                              </div>
