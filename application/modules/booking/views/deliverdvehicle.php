                    ...
                    <div class="x_content">
                         <form action="" method="get">
                              <table>
                                   <tr>
                                        <td>
                                             <input autocomplete="off" name="vbk_delivery_date_from" type="text" class="dtpEnquiry form-control col-md-7 col-xs-12" 
                                                  placeholder="Delivery date from" value="<?php echo isset($_GET['vbk_delivery_date_from']) ? $_GET['vbk_delivery_date_from'] : ''; ?>"/>
                                        </td>
                                        <td style="padding-left: 10px;">
                                             <input autocomplete="off" name="vbk_delivery_date_to" type="text" class="dtpEnquiry form-control col-md-7 col-xs-12" 
                                                  placeholder="Delivery date to" value="<?php echo isset($_GET['vbk_delivery_date_to']) ? $_GET['vbk_delivery_date_to'] : ''; ?>"/>
                                        </td>
                                             <?php if (check_permission('reports', 'fltr_enquiries_enq_salesstaff')) {?>
                                                  ...
                                                  <td style="padding-left: 10px;">
                                                       ...
                                                       <select style="float: left;width: auto;" class="select2_group form-control" name="div">
                                                            ...
                                                            <option value="1" <?php echo ($div == 1) ? 'selected="selected"' : ''; ?>>Smart</option>
                                                            <option value="2" <?php echo ($div == 2) ? 'selected="selected"' : ''; ?>>Luxury</option>
                                                       </select>
                                                  </td>
                                             <?php } ?>
                                        </tr>
                              ...
                              <tbody>
                                   ...
                                   foreach ((array) $bookedVehicle as $key => $value) {
                                        ...
                                        <tr data-url="<?php echo $url; ?>">
                                             ...
                                             <td class="trVOE"><?php echo!empty($value['vbk_expect_delivery']) ? date('j M Y', strtotime($value['vbk_expect_delivery'])) : ''; ?></td>
                                             <td class="trVOE"><?php echo!empty($value['vbk_delivery_date']) ? date('j M Y', strtotime($value['vbk_delivery_date'])) : ''; ?></td>
                                             <!-- <td title="<?php //echo $value['sts_des']; ?>" class="trVOE"><?php //echo $value['sts_title']; ?></td> -->
                                             <td title="<?php echo $value['rfi_in_sts_title']; ?>" class="trVOE"><?php echo $value['rfi_in_sts_title']; ?></td>
                                             <td title="<?php echo $value['rfi_rc_sts_title']; ?>" class="trVOE"><?php echo $value['rfi_rc_sts_title']; ?></td>
                                             <td title="<?php echo $value['rfi_sts_title']; ?>" class="trVOE"><?php echo $value['rfi_sts_title']; ?></td>
