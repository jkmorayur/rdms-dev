     ...
     <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
               <div class="x_panel">
                                     ...
                                     <?php } if (check_permission('reports', 'fltr_enquiries_enq_salesstaff')) {?>
                                          <td style="padding-left: 10px;">
                                               <select multiple="multiple" style="float: left;width: auto;" class="cmbMultiSelect select2_group form-control cmbSalesExecutives" name="executive[]">
                                                    <option value="<?php echo $this->uid; ?>" <?php echo (@in_array($$executive, $this->uid)) ? 'selected="selected"' : '';?>>My self</option>
                                                    <?php
                    ...
                    <div class="x_content">
                         <table id="tblEnqReport" class="table table-striped table-bordered display nowrap" style="width:100%;white-space: nowrap;">
                              <thead>
                                   <tr>
                                        <th>Customer ID</th>
                                        <th>Customer</th>
                                     ...
                                     foreach ((array) $searchResult as $key => $veh) {
                                          ...
                                          <tr data-url="<?php echo site_url('enquiry/printTrackCard/' . encryptor($veh['enq_id']));?>">
                                               ...
                                               <td><?php echo date('j M Y', strtotime($veh['enq_next_foll_date'])); ?></td>
                                                ...
                                                <?php } ?>
                                                <td><?php echo !empty($veh['enq_home_visit_date']) ? date('j M Y', strtotime($veh['enq_home_visit_date'])) : ''; ?></td>
                                                ...
                                                <td><?php echo isset($veh['enq_last_foll_cust_rmk']) ? $veh['enq_last_foll_cust_rmk'] : ''; ?></td>
                         ...
                         <?php } if (check_permission('reports', 'allowresinedstfenqreassign')) { ?>
                                   <div class="col-md-4 col-sm-4 col-xs-12">
                                        <div class="x_panel tile fixed_height_320">
                                             <div class="x_title">
                                                  <h2>Move resigned staff enquiries</h2>
                                                  <div class="clearfix"></div>
                                             </div>
                                             <div class="dashboard-widget-content">
                                                  <div class="x_content">
