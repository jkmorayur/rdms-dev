                                          ...
                                          foreach ($data as $key => $value) { ?>
                                               <tr data-url="<?php echo site_url($controller . '/view/' . $value['desig_id']);?>">
                                                    ...
                                                    <td>
                                                       ...
                                                       if($travelDetails) {
                                                       ?>
                                                            <i class="fa fa-globe" data-toggle="modal" data-target="#travelDetails<?php echo $value['desig_id']; ?>"></i>
                                                            <div class="modal fade" id="travelDetails<?php echo $value['desig_id']; ?>" tabindex="-1" role="dialog" 
                                                                      aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                 <div class="modal-dialog" role="document">
                                                                      <div class="modal-content">
                                                                           <div class="modal-header">
                                                                                <h5 style="float: left;" class="modal-title" id="exampleModalLabel">Travel Details</h5>
