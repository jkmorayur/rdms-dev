                              ...
                              <div class="col-sm-6">
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input type="text" class="form-control col-md-7 col-xs-12" name="val_cust_name" 
                                                    id="val_cust_name" placeholder="Customer Name" value="<?php echo $stockVehicle['val_cust_name']; ?>"/>
                                        </div>
                                   </div>
                              </div>
                              <div class="col-sm-6">
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input type="text" class="form-control col-md-7 col-xs-12" name="val_cust_phone" 
                                                    id="val_cust_phone" placeholder="Phone Number" value="<?php echo $stockVehicle['val_cust_phone']; ?>"/>
                                        </div>
                                   </div>
                              </div>
                         </div>
                         <div class="row">
                              <div class="col-sm-6">
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input type="text" class="form-control col-md-4 col-xs-6" value="<?php echo $stockVehicle['val_cust_email']; ?>"
                                                    placeholder="Email" name="val_cust_email" id="val_cust_email"/>
                                        </div>
                                   </div>
                              </div>
                              <div class="col-sm-6">
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input required type="text" class="form-control col-md-7 col-xs-12" name="val_cust_place" 
                                                    value="<?php echo $stockVehicle['val_cust_place']; ?>"
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input type="text" class="form-control col-md-7 col-xs-12"
                                                    value="<?php echo $stockVehicle['val_rc_owner']; ?>" 
                                                    name="val_rc_owner" id="val_rc_owner" placeholder="RC owner name"/>
                                        </div>
                                   </div>
                              </div>
                              <div class="col-sm-6">
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input required="required" class="form-control col-md-7 col-xs-12 numOnly" 
                                                    ...
                                                    placeholder="No.of Owner(s)" type="number" name="val_no_of_owner" id="val_no_of_owner">
                                        </div>
                                   </div>
                              </div>
                         </div>
                              ...
                              <div class="col-sm-6">
                                   <div class="form-group">
                                        <label class="control-label col-md-4 col-sm-3 col-xs-12">No.of Seats</label>
                                             <div class="col-md-6 col-sm-6 col-xs-12">
                                                  <input required="required" class="form-control col-md-7 col-xs-12 numOnly" value="<?php echo $stockVehicle['val_no_of_seats']; ?>" 
                                                         placeholder="No.of Seats"  type="number" name="val_no_of_seats" id="val_no_of_seats">
                                        </div>
                                   </div>
                              </div>
                              <div class="col-sm-6">
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input required="required" type="number" class="form-control col-md-7 col-xs-12" name="val_eng_cc" 
                                                    value="<?php echo $stockVehicle['val_eng_cc']; ?>" id="val_eng_cc" placeholder="Eng CC"/>
                                        </div>
                                   </div>
                              </div>
                         </div>
                         ...
                         <div class="row">
                              ...
                              <div class="col-sm-6">
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input type="number" class="numOnly form-control col-md-7 col-xs-12" name="val_cust_age" 
                                                    value="<?php echo $stockVehicle['val_cust_age']; ?>" id="val_eng_cc" placeholder="Age"/>
                                        </div>
                                   </div>
                              </div>
                         </div>
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input type="number" class="numOnly form-control col-md-7 col-xs-12" name="val_hp" 
                                                    value="<?php echo $stockVehicle['val_hp']; ?>" id="val_eng_cc" placeholder="HP"/>
                                        </div>
                                   </div>
                              </div>
                         </div>
                         ...
                         <div class="row">
                              ...
                              <table class="table table-striped table-bordered">
                                   ...
                                   <tr>
                                        ...
                                        <td><input value="<?php echo!empty($stockVehicle['val_insurance_comp_date']) ? date('d-m-Y', strtotime($stockVehicle['val_insurance_comp_date'])) : '';?>" placeholder="Valid UP to (comprehensive)" 
                                             type="text" class="form-control col-md-7 col-xs-12 dtpDatePickerEvaluation" name="val_insurance_comp_date"/></td>

                                        <td><input value="<?php echo $stockVehicle['val_insurance_comp_idv']; ?>" placeholder="IDV Value (comprehensive)" 
                                             type="text" class="form-control col-md-7 col-xs-12 decimalOnly" name="val_insurance_comp_idv"/></td>
                                   </tr>
                                   <tr>
                                        <td>Limited Liability</td>

                                        <td><input placeholder="Limited Liability (Limited Liability)" type="text" class="form-control col-md-7 col-xs-12 dtpDatePickerEvaluation" 
                                        value="<?php echo!empty($stockVehicle['val_insurance_ll_date']) ? date('d-m-Y', strtotime($stockVehicle['val_insurance_ll_date'])) : '';?>" name="val_insurance_ll_date"/></td>

                                        <td><input placeholder="NCB" type="text" value="<?php echo $stockVehicle['val_insurance_ll_idv']; ?>" 
                                        class="form-control col-md-7 col-xs-12" name="val_insurance_ll_idv"/></td>
                                   </tr>
                                   <tr>
                                        <td>NCB need by Customer</td>
                                        <td><input <?php echo ($stockVehicle['val_insurance_need_ncb'] == 1) ? 'checked' : '';?> value="1" 
                                                       type="checkbox" name="val_insurance_need_ncb"/></td>
                                        <td>
                                             ...
                                             <div style="float: left;width: 200px;margin-left: 20px;">
                                                  <select class="col-md-2 col-xs-5 select2_group form-control"
                                                       ...
                                                       <?php foreach (unserialize(INSURANCE_TYPES) as $key => $value) { ?>
                                                            <option <?php echo ($stockVehicle['val_insurance'] == $key) ? 'selected="selected"' : '';?> 
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input type="text" class="form-control col-md-7 col-xs-12 txtValHypoBankBranch" 
                                                  value="<?php echo $stockVehicle['val_insurance_company'];?>"
                                                    name="val_insurance_company" id="val_hypo_bank_branch" placeholder="Insurance company Name"/>
                                        </div>
                                   </div>
                              </div>
                              ...
                              <div class="col-sm-6">
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             ...
                                             <input type="text" class="form-control col-md-7 col-xs-12" value="<?php echo $remark;?>" name="val_ins_remarks" 
                                                    id="val_ins_remarks" placeholder="Remarks"/>
                                        </div>
                                   </div>
                              </div>
                         </div>              
