                         ...
                         if (can_access_module('investors')) { ?>
                              <li><a><i class="fa fa-dollar"></i> Investors <span class="fa fa-chevron-down"></span></a>
                                   <ul class="nav child_menu">
                                        ...
                                        <?php } if (check_permission('investors', 'webinvestors')) { ?>
                         ...
                         if (can_access_module('enquiry') || can_access_module('customer_grade') || can_access_module('booking')) { ?>
                              <li><a><i class="fa fa-cab"></i> Enquiry <span class="fa fa-chevron-down"></span></a>
                                   <ul class="nav child_menu">
                                        ...
                                        <?php } if (check_permission('enquiry', 'pool')) { ?>
                                             <li><a href="<?php echo site_url('enquiry/pool'); ?>">Enquires pool</a></li>
                                        <?php } if (check_permission('enquiry', 'add')) { ?>
     ...
     <li><a><i class="fa fa-calendar-check-o"></i> Followup* <span class="fa fa-chevron-down"></span></a>
          <ul class="nav child_menu">
               ...
               if (check_permission('followup_new', 'precurementrqstlist')) { ?>
                    <li><a href="<?php echo site_url('followup_new/precurementRqstList'); ?>"> Procurement req list
                         </a></li>
               <?php } ?>
               ...
               <?php if (check_permission('homevisit', 'hw_can_add_request')) { ?> <li><a href="<?php echo site_url('followup_new/home_visit'); ?>"> My home visit <?php } ?>
                    ...
                    <?php if (check_permission('homevisit', 'hw_all') or check_permission('homevisit', 'hw_smart_only') or check_permission('homevisit', 'hw_my_own') or check_permission('homevisit', 'hw_my_team') or check_permission('homevisit', 'hw_smart_purchase_only') or check_permission('homevisit', 'hw_smart_sales_only') or check_permission('homevisit', 'hw_my_shwroom') or check_permission('homevisit', 'hw_luxury_only') or check_permission('homevisit', 'hw_luxury_purchase_only') or check_permission('homevisit', 'hw_luxury_sales_only')) { ?> <li><a href="<?php echo site_url('followup_new/home_visit_approval_req'); ?>"> Home visit Approval Req.<?php } ?>
                              </a></li>
                         ...
                         ?>
                              <li><a><i class="fa fa-bar-chart"></i> Reports <span class="fa fa-chevron-down"></span></a>
                                   <ul class="nav child_menu">
                                        ...
                                        <?php } if (check_permission('reports', 'pool')) { ?>
                                             <li><a href="<?php echo site_url('reports/pool'); ?>">Enquires pool</a></li>
                                        <?php } if (check_permission('reports', 'homevisitneeded')) { ?>
                                        ...
                                        if (check_permission('reports', 'stockagainstvehicle')) { ?>
                                             ...
                                             <?php
                                              if (check_permission('reports', 'stock_status_summary')) { ?>
                                                  <li><a href="<?php echo site_url('reports/stock_status_summary'); ?>">Stock status summary*</a></li>
                                             <?php } ?>
                                             <?php
                                             ...
                                             <?php
                                              if (check_permission('reports', 'booked_stock_report')) { ?>
                                                  <li><a href="<?php echo site_url('reports/booked_stock_report'); ?>">Booked stock report*</a></li>
                                             <?php } ?>
                                             <?php
                                             ...
                                             <?php
                                              if (check_permission('reports', 'purchase_new_live_enqs')) { ?>
                                                  <li><a href="<?php echo site_url('reports/purchase_new_live_enqs'); ?>">Purchase report.*</a></li>
                                             <?php } ?>
...
"></span></a></li>
                                        ...
                                        <?php
                                              if (check_permission('reports', 'enq_model_wise_analysis')) { ?>
                                                  <li><a href="<?php echo site_url('reports/enq_model_wise_analysis'); ?>">Sl Enq Model Wise Analysis*</a></li>
                                             <?php } ?>
                                             <?php
                                              if (check_permission('reports', 'summary_enq_purchase')) { ?>
                                                  <li><a href="<?php echo site_url('reports/summary_enq_purchase'); ?>">Purchase Summary*</a></li>
                                             <?php } ?>

                                             <?php
                                              if (check_permission('reports', 'detailed_walk_in_report')) { ?>
                                                  <li><a href="<?php echo site_url('reports/detailed_walk_in_report'); ?>">Walk-in Report*</a></li>
                                             <?php } ?>
                              ...
                              <li><a><i class="fa fa-bar-chart"></i> Reports * <span class="fa fa-chevron-down"></span></a>
                                   <ul class="nav child_menu">
                                        <?php if (check_permission('reports_1', 'quickVehicleSearch')) { ?>
                                             <li><a href="<?php echo site_url('reports_1/quickVehicleSearch'); ?>">Quick Vehicle Search</a></li>
                                        <?php }
                                        ...
                                        if (check_permission('reports_1', 'enquiries')) { ?>
                                             <li><a href="<?php echo site_url('reports_1/enquiries'); ?>">Inquiries (Vehicle based)</a></li>
                                        <?php }
                                        if (check_permission('reports_1', 'enquiries_enq')) { ?>
                                             <li><a href="<?php echo site_url('reports_1/enquiries_enq'); ?>">Inquiries (Inquiry based)</a></li>
                                        <?php }
                                        ...
                                        if (check_permission('reports_1', 'droppedEnquiries')) { ?>
                                             <li><a href="<?php echo site_url('reports_1/droppedEnquiries'); ?>">Dropped Enquiries</a></li>
                                        <?php }
                                        if (check_permission('reports_1', 'deletedenquiries')) { ?>
                                             <li><a href="<?php echo site_url('reports_1/deletedEnquiries'); ?>">Deleted Enquiries</a></li>
                                        <?php }
                                        ...
                                        if (check_permission('reports_1', 'deliveredvehicles')) { ?>
                                             <li><a href="<?php echo site_url('reports_1/deliveredvehicles'); ?>">Delivered vehicles</a></li>
                                        <?php }
                                        if (check_permission('booking', 'bookingcancelled')) { ?>
                                             <li><a href="<?php echo site_url('booking/bookingCancelled'); ?>">Cancelled vehicles</a></li>
                                        <?php }
                                        ...
                                        if (check_permission('reports_1', 'homevisitneeded')) { ?>
                                             <li><a href="<?php echo site_url('reports_1/homeVisitNeeded'); ?>">Home Visit Needed</a></li>
                                        <?php }
                                        ...
                                        if (check_permission('reports_1', 'voxbaydailyreport')) { ?>
                                             <li><a href="<?php echo site_url('reports_1/voxbayDailyReport'); ?>">Voxbay daily report</a></li>
                                        <?php }
                                        if (check_permission('reports_1', 'quickenquiryfedBack')) { ?>
                                             <li><a href="<?php echo site_url('reports_1/quickEnquiryFedBack'); ?>">Quick followup report</a></li>
                                        <?php }
                                        if (check_permission('reports_1', 'voxbaypunchreprt')) { ?>
                                             <li><a href="<?php echo site_url('reports_1/voxbayPunchReprt'); ?>">Voxbay punch report</a></li>
                                        <?php }
                                        if (check_permission('reports_1', 'telcalrperformancereport')) { ?>
                                             <li><a href="<?php echo site_url('reports_1/telcalrperformancereport'); ?>">Telecaller performance report</a></li>
                                        <?php }
...
"></span></a></li>
                                        ...
                                        <li><a href="<?php echo site_url('reports_1/enq_model_wise_analysis'); ?>">Sl Enq Model Wise Analysis
                                                  <span class="glyphicon glyphicon-asterisk	
"></span></a></li>
                              ...
                              <li><a><i class="fa fa-users"></i> Staff Details <span class="fa fa-chevron-down"></span></a>
                                   <ul class="nav child_menu">
                                       ...
                                       <?php if (check_permission('emp_details', 'staff_target')) { ?>
                                        <li><a href="<?php echo site_url('emp_details/staff_target/1');?>">Sales&purchase target</a></li>
                                                  <li><a href="<?php echo site_url('emp_details/staff_target/2');?>">Valuation target</a></li>
                                                  <?php } ?>
                                   </ul>
                              </li>
                         <?php
                         ...
                         if (can_access_module('voxbay')) { ?>
                              <li>
                                   ...
                                   <ul class="nav child_menu">
                                        ...
                                        <?php } if (check_permission('voxbay', 'allconnectedincall')) { ?>
                                             <li><a href="<?php echo site_url('voxbay/allconnectedincall'); ?>">All inbount call</a></li>
                                        <?php } if (check_permission('voxbay', 'allconnectedoutcall')) { ?>
                                             <li><a href="<?php echo site_url('voxbay/allconnectedoutcall'); ?>">All outbound call</a></li>
                                        <?php } ?>
                                   </ul>
                              </li>
                         <?php }
